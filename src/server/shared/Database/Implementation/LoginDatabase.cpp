...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_SEL_ACCOUNT_LIST_BY_EMAIL, "SELECT a.id, a.username FROM account a LEFT JOIN battlenet_accounts ba on (ba.id = a.battlenet_account) WHERE ba.email = ?", CONNECTION_SYNCH);
