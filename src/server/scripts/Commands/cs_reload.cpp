...
public:
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading Loot Tables... (`world_loot_template`)");
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading Loot Tables... (`zone_loot_template`)");
        LoadLootTemplates_World();
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading Loot Tables... (`luck_loot_template`)");
        LoadLootTemplates_World();
    ...
    {
        sLog->outInfo(LOG_FILTER_SERVER_LOADING,"Re-Loading Bad Sentences...");
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading `deathmatch_products` Table!");
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading scenario_data...");
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading pvp_reward...");
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading World Quest...");
