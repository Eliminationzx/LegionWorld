...
public:
    ...
    static bool HandleNpcAddVendorItemCommand(ChatHandler* handler, char const* args)
    {
        ...
        handler->PSendSysMessage(LANG_ITEM_ADDED_TO_LIST, itemId, itemTemplate->Name->Str[handler->GetSessionDbLocaleIndex()], maxcount, incrtime, extendedcost);
        return true;
    }
    ...
    static bool HandleNpcDeleteVendorItemCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_ITEM_DELETED_FROM_LIST, itemId, itemTemplate->Name->Str[handler->GetSessionDbLocaleIndex()]);
        return true;
    }
