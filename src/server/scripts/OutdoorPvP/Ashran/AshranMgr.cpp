...
{
    sLog->outError(LOG_FILTER_GENERAL, "OutdoorPvPAshran: SetupOutdoorPvP");
    ...
    for (uint8 i = EmberfallTower; i < MaxBattleType; ++i)
    {
        ...
        sLog->outError(LOG_FILTER_GENERAL, "OutdoorPvPAshran: SetupOutdoorPvP:: AddCapturePoint %u", i);
    }
...
void OutdoorPvPAshran::FillInitialWorldStates(WorldPackets::WorldState::InitWorldStates& packet)
{
    ...
    sLog->outError(LOG_FILTER_GENERAL, "OutdoorPvPAshran: FillInitialWorldStates");
