...
class duel_zone : public PlayerScript
{
    public:
        ...
        {
            if (winner->GetAreaId() != AllowedArea && winner->GetZoneId() != AllowedZone)
                return;
        ...
        {
            if (player1->GetAreaId() != AllowedArea && player1->GetZoneId() != AllowedZone)
                return;
...
public:
    ...
    { 
        ...
        {
            if (player->GetAreaId() == AllowedArea || player->GetZoneId() == AllowedZone)
            {
