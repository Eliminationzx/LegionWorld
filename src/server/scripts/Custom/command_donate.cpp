...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand tokensCommandTable[] =
        {
            ...
            { "modify",         SEC_CONFIRMED_GAMEMASTER,         false, &HandleModTokensCommand,            "", NULL },
            { NULL,             0,                  false, NULL,                                "", NULL }
        };
    ...
    static bool HandleAddMorphCommand(ChatHandler* handler, const char* args)
    {
        ...
        sLog->outDebug(LOG_FILTER_DONATE, "[Buy] Morph entry = %u, cost = %u, %s", morphId, tokenCount, target->GetInfoForDonate().c_str());
    ...
    static bool HandleDelMorphCommand(ChatHandler* handler, const char* args)
    {
        ...
        {  
            do
            {
                ...
                {
                    sLog->outDebug(LOG_FILTER_DONATE, "[Status] Return morph entry = %u, return_tokens = %u, %s", morphId, tokenCount, target->GetInfoForDonate().c_str());
   ...
   static bool HandleAddMountFlyCommand(ChatHandler* handler, const char* args)
    {
       ...
       sLog->outDebug(LOG_FILTER_DONATE, "[But] Fly mount entry = %u, cost = %u, %s", mountId, tokenCount, target->GetInfoForDonate().c_str());
        ...
        {  
            do
            {
                ...
                if (target->AddDonateTokenCount(tokenCount))
                {
                    ...
                    sLog->outDebug(LOG_FILTER_DONATE, "[Status] Return fly mount entry = %u, return_tokens = %u, %s", mountId, tokenCount, target->GetInfoForDonate().c_str());
...
// ground
    ...
    static bool HandleAddMountGroundCommand(ChatHandler* handler, const char* args)
    {
        ...
        sLog->outDebug(LOG_FILTER_DONATE, "[Buy] Ground mount entry = %u, cost = %u, %s", mountId, tokenCount, target->GetInfoForDonate().c_str());
    ...
    static bool HandleDelMountGroundCommand(ChatHandler* handler, const char* args)
    {
        ...
        {  
            do
            {
                ...
                if (target->AddDonateTokenCount(tokenCount))
                {
                    sLog->outDebug(LOG_FILTER_DONATE, "[Status] Return ground mount entry = %u, return_tokens = %u, %s", mountId, tokenCount, target->GetInfoForDonate().c_str());
    ...
    static bool HandleAddDonatCommand(ChatHandler* handler, const char* args)
    {
        ...
        sLog->outDebug(LOG_FILTER_DONATE, "[Buy Online] item entry = %u, cost = %u, %s", itemId, tokenCount, target->GetInfoForDonate().c_str());
