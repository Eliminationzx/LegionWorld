    ...
    public:
        ...
        class spell_dk_death_gate_teleport_SpellScript : public SpellScript
        {
            ...
            void HandleTeleport(SpellEffIndex effIndex)
            {
                ...
                {
                    if(_player->GetZoneId() == (GetSpellInfo()->Id == 187753 ? 7679 : 139))
                    {
...
class spell_dk_death_grip_dummy : public SpellScriptLoader
{
    public:
        ...
        class spell_dk_death_grip_dummy_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnEffectHitTarget += SpellEffectFn(spell_dk_death_grip_dummy_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
...
class spell_dk_scourge_strike : public SpellScriptLoader
{
    public:
        ...
        class spell_dk_scourge_strike_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnHit += SpellHitFn(spell_dk_scourge_strike_SpellScript::HandleOnHit);
            }
        };
...
class spell_dk_shadow_empowerment : public SpellScriptLoader
{
    public:
        spell_dk_shadow_empowerment() : SpellScriptLoader("spell_dk_shadow_empowerment") { }

        class spell_dk_shadow_empowerment_AuraScript : public AuraScript
        {
            PrepareAuraScript(spell_dk_shadow_empowerment_AuraScript);
            ...
            void Register() override
            {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_dk_shadow_empowerment_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE);
            }
        };

        AuraScript* GetAuraScript() const override
        {
            return new spell_dk_shadow_empowerment_AuraScript();
        }
};
        ...
        class spell_dk_apocalypse_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if(caster && target)
                {
                    if (Aura* aura = target->GetAura(194310, caster->GetGUID()))
                    {
                        int32 count = aura->GetStackAmount(); // In 7.1.0 max 6 count
                        if (count > GetSpellInfo()->Effects[EFFECT_2]->BasePoints)
                            count = GetSpellInfo()->Effects[EFFECT_2]->BasePoints;
                        for (int i = 0; i < count; i++)
                        {
                            caster->CastSpell(target, 194311, true);
    ...
    public:
        ...
        class spell_dk_umbilicus_eternus_AuraScript : public AuraScript
        {
            ...
            void OnRemove(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (bp > 0)
                    caster->CastCustomSpell(caster, 193320, &bp, NULL, NULL, true);
            }
...
// Reanimation (Honor Talent) - 210128
class spell_dk_reanimation : public SpellScriptLoader
{
    public:
        spell_dk_reanimation() : SpellScriptLoader("spell_dk_reanimation") { }

        class spell_dk_reanimation_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_dk_reanimation_SpellScript);
            ...
            void HandleOnCast()
            {
                if (Unit* caster = GetCaster())
                {
                    ...
                    caster->GetNearPosition(summonPos, caster->GetObjectSize(), caster->GetAngle(summonPos.m_positionX, summonPos.m_positionY));
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                GetHitDest()->Relocate(*GetExplTargetDest());
            }

            void Register() override
            {
                OnEffectHit += SpellEffectFn(spell_dk_reanimation_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SUMMON);
                OnCast += SpellCastFn(spell_dk_reanimation_SpellScript::HandleOnCast);
            }
        };

        SpellScript* GetSpellScript() const override
        {
            return new spell_dk_reanimation_SpellScript();
        }
};
...
void AddSC_deathknight_spell_scripts()
{
    ...
    new spell_dk_shadow_empowerment();
