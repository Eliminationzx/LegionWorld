    ...
    public:
        ...
        struct boss_vanessa_vancleefAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*who*/)  override
            {
                ...
                events.ScheduleEvent(EVENT_ADDS_1, 9000);
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_ADDS_1:
                            if ((me->GetHealth() * 100) / me->GetMaxHealth() > 50)
                            {
                                ...
                                events.ScheduleEvent(EVENT_ADDS_2, 15000);
                            }
                            break;
                        case EVENT_ADDS_2:
                            if ((me->GetHealth() * 100) / me->GetMaxHealth() > 50)
                            {
                                ...
                                events.ScheduleEvent(EVENT_ADDS_3, 15000);
                            }
                            break;
                        case EVENT_ADDS_3:
                            if ((me->GetHealth() * 100) / me->GetMaxHealth() > 50)
                            {
                                ...
                                events.ScheduleEvent(EVENT_ADDS_1, 15000);
                            }
