...
public:
    ...
    struct boss_brawguild_sanoriakAI : public BrawlersBossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_4, 26000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_1:
                        ...
                        events.ScheduleEvent(EVENT_1, urand(17000, 18000));
                        break;
                    case EVENT_2:
                        DoCast(SPELL_PYROBLAST);
                        events.ScheduleEvent(EVENT_2, urand(27000, 32000));
                        break;
                    case EVENT_3:
                        DoCast(SPELL_FIREBALL);
                        events.ScheduleEvent(EVENT_3, urand(4000, 4500));
                        break;
                    case EVENT_4:
                        DoCast(SPELL_FLAME_BUFFET);
                        events.ScheduleEvent(EVENT_4, urand(12000, 14000));
                        break;
                    case EVENT_5:
                        DoCastVictim(132662);
                        DoCastVictim(132663);
