...
public:
    ...
    struct boss_brawguild_shadowmasterAI : public BrawlersBossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_2, 2000+6000);
        }
...
public:
    ...
    struct boss_brawguild_johnnyAI : public BrawlersBossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_1, urand(6000, 7000)); 
            events.ScheduleEvent(EVENT_2, urand(9000, 12000));
        ...
        {            
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_4:
                        DoCast(SPELL_SHOOT);
                        events.ScheduleEvent(EVENT_4, 2002);
                        break;
                }
            }
            // DoMeleeAttackIfReady();
