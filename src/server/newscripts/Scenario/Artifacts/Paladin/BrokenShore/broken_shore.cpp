...
public:
    ...
    struct npc_bs_boss_jailer_zerusAI : ScriptedAI
    {
        ...
        //13:37
        {
            ...
            events.ScheduleEvent(EVENT_1, 5000); //13:42, 14:07
            events.ScheduleEvent(EVENT_2, 15000); //13:52, 14:18
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_2:
                        ...
                        events.ScheduleEvent(EVENT_2, 26000);
                        break;
                    case EVENT_3:
                        me->StopAttack();
...
public:
    ...
    struct npc_bs_balnazzarAI : ScriptedAI
    {
        ...
        //21:26
        {
            ...
            events.ScheduleEvent(EVENT_7, 16000);
            events.ScheduleEvent(EVENT_8, 1000);
        }
