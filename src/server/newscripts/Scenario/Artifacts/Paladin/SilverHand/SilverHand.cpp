...
public:
    ...
    struct npc_travar_firstAI : ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_1, 5000); // 215689
            events.ScheduleEvent(EVENT_2, 8000); // 210371
        }
...
public:
    ...
    struct npc_horrific_aberrationAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            events.ScheduleEvent(EVENT_1, 30000); // 215797
            events.ScheduleEvent(EVENT_2, 2500); //  215690
        }
...
public:
    ...
    struct npc_efrin_and_duvalAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            events.ScheduleEvent(EVENT_1, 4500); // 212290
            events.ScheduleEvent(EVENT_2, 9300); // 210369
            events.ScheduleEvent(EVENT_3, 7000); // 210371
        }
