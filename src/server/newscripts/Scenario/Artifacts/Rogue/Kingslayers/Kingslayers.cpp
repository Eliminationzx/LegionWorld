...
public:
    ...
    struct npc_sister_althea_ebonlockeAI : ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_1, 3000); // convers
            events.ScheduleEvent(EVENT_5, 27000); // 202839
            events.ScheduleEvent(EVENT_6, 15000); // 203109
            events.ScheduleEvent(EVENT_7, 25000); // 207673
...
public:
    ...
    struct npc_merlis_malaganAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            events.ScheduleEvent(EVENT_1, 5000); // 15 218359 + 218356 + summon
