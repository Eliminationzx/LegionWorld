...
public:
    ...
    struct npc_ragnvald_dragonbornAI : ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_1, 12000); // 13736
            events.ScheduleEvent(EVENT_2, 6000); // 12 15708
            events.ScheduleEvent(EVENT_3, 15000); // 15588
            events.ScheduleEvent(EVENT_4, 9000); // 13 16044
        }
...
public:
    ...
    struct npc_bezzeredAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            events.ScheduleEvent(EVENT_1, 16000); // 196814
            events.ScheduleEvent(EVENT_2, 23000); // 17 196808
        }
...
public:
    ...
    struct npc_malgalorAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_2, 11000); // 207942
            events.ScheduleEvent(EVENT_3, 17000); // 197816
            events.ScheduleEvent(EVENT_4, 21000); // 197818
        }
        ...
        void DamageTaken(Unit* who, uint32 &damage, DamageEffectType dmgType) override
        {
            ...
            {
                DoCast(186382);
                events.ScheduleEvent(EVENT_5, 5500);
                outro = true;
            }
            if (outro)
                damage = 0;
