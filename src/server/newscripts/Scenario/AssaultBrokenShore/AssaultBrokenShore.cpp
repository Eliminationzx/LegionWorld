...
public:
    ...
    struct npc_broken_shore_miscAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            {
                case 119133:
                    events.ScheduleEvent(EVENT_1, 6000); // 226063
                    DoCast(225184);
                    break;
                case 118412:
                    events.ScheduleEvent(EVENT_2, 2500); // 183108
                    events.ScheduleEvent(EVENT_3, 18000); // 183075
                    break;
                case 121232:
                    events.ScheduleEvent(EVENT_4, 2300); // 182856
                    events.ScheduleEvent(EVENT_5, 14000); // 182854 (friendly)
                    DoCast(79833);
                    break;
                case 118966:
                    events.ScheduleEvent(EVENT_6, 4000); // 190330
                    events.ScheduleEvent(EVENT_7, 35000); // 189804
                    events.ScheduleEvent(EVENT_8, 11000); // 190332
                    events.ScheduleEvent(EVENT_9, 14000); // 190331
                    break;
                case 121146:
                    events.ScheduleEvent(EVENT_10, 3000); // 183555
                    events.ScheduleEvent(EVENT_11, 13000); // 183553
                    events.ScheduleEvent(EVENT_12, 15000); // 183549 (friendly)
                    break;
                case 118969:
                    events.ScheduleEvent(EVENT_13, 7000); // 222971
                    events.ScheduleEvent(EVENT_14, 27000); // 223061
                    events.ScheduleEvent(EVENT_15, 21000); // 223109
                    events.ScheduleEvent(EVENT_16, 31000); // 223903
                    break;
                case 118945:
                    events.ScheduleEvent(EVENT_17, 4000); // 183894
                    events.ScheduleEvent(EVENT_18, 9000); // 183897
                    events.ScheduleEvent(EVENT_19, 39000); // 183898
                    events.ScheduleEvent(EVENT_20, 31000); // 190010
                    break;
                case 118444:
                    events.ScheduleEvent(EVENT_21, 3000); // 183108
                    events.ScheduleEvent(EVENT_22, 20000); // 13730
                    break;
            }
        }
