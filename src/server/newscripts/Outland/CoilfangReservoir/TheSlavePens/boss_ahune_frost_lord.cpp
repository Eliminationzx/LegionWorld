...
public:
    ...
    struct boss_ahune_frost_lordAI : BossAI
    {
        ...
        {
            Phase = 1;
            events.ScheduleEvent(EVENT_BIGADD, 5000);
            events.ScheduleEvent(EVENT_SMALLADD, 8000);
            events.ScheduleEvent(EVENT_CRYSTAL, 90000);
            events.ScheduleEvent(EVENT_ICESPEAR, 2000);
            DoCast(46146);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_BIGADD:
                    ...
                    events.ScheduleEvent(EVENT_BIGADD, 20000);
                    break;
                case EVENT_SMALLADD:
                    if (Phase == 1)
                    {
                ...
                case EVENT_CRYSTAL:
                    ...
                    events.ScheduleEvent(EVENT_CRYSTAL, 120000);
                    Submerge();
                    Phase = 2;
                    break;
                case EVENT_RESET:
                ...
                case EVENT_ICESPEAR:
                    ...
                    events.ScheduleEvent(EVENT_ICESPEAR, 10000);
                    break;
