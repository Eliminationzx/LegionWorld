...
public:
    ...
    struct boss_ivanyrAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_VOLATILE_MAGIC, 8000);
            events.ScheduleEvent(EVENT_OVERCHARGE_MANA, 28000);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (CheckTimer <= diff)
            {
                if (me->isInCombat() && me->GetMap()->GetDifficultyID() == DIFFICULTY_MYTHIC_DUNGEON)
                {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_OVERCHARGE_MANA:
                        ...
                        events.ScheduleEvent(EVENT_OVERCHARGE_MANA, 40000);
                        break;
