...
struct boss_goroth : BossAI
{
    ...
    void EnterCombat(Unit* /*who*/) override
    {
        ...
        events.ScheduleEvent(EVENT_BURNING_ARMOR, 10000);
        events.ScheduleEvent(EVENT_CRASHING_COMET, 8000);
        events.ScheduleEvent(EVENT_INFERNAL_SPIKE, 4000);
        events.ScheduleEvent(EVENT_SHATTERING_STAR, IsMythicRaid() ? 34000 : 24000);

        if (IsMythicRaid())
            events.ScheduleEvent(EVENT_RAIN_OF_BRIMSTONE, 12000);
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_BURNING_ARMOR:
                    ...
                    events.ScheduleEvent(EVENT_BURNING_ARMOR, 24000);
                    break;
                case EVENT_CRASHING_COMET:
                {
                    ...
                    summons.DoAction(ACTION_1, pred);
                    events.ScheduleEvent(EVENT_CRASHING_COMET, 18000);
                    break;
                }
                case EVENT_INFERNAL_SPIKE:
                    DoCast(SPELL_INFERNAL_SPIKE_FILTER);
                    events.ScheduleEvent(EVENT_INFERNAL_SPIKE, 16000);
                    break;
                case EVENT_SHATTERING_STAR:
                    ...
                    events.ScheduleEvent(EVENT_SHATTERING_STAR, shatteringTimer);
                    break;
                case EVENT_RAIN_OF_BRIMSTONE:
                    ...
                    events.ScheduleEvent(EVENT_RAIN_OF_BRIMSTONE, rainBrimstoneTimer);
                    break;
            }
        }
