...
struct boss_mistress_sasszine : BossAI
{
    ...
    void ChangePhase()
    {
        ...
        {
            case 1:
                events.ScheduleEvent(EVENT_THUNDERING_SHOCK, 10000);
                events.ScheduleEvent(EVENT_CONSUMING_HUNGER, IsHeroicPlusRaid() ? 20000 : 64000);
                ...
                if (IsHeroicRaid())
                {
                    ...
                    events.ScheduleEvent(EVENT_BURDEN_OF_PAIN, 15000);
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, 25000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 30000);
                }
                else if (IsMythicRaid())
                {
                    ...
                    events.ScheduleEvent(EVENT_BURDEN_OF_PAIN, 16000);
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, 36000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 30000);
                }
                else
                {
                    ...
                    events.ScheduleEvent(EVENT_BURDEN_OF_PAIN, 19000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 36000);
                    if (!IsLfrRaid())
                        events.ScheduleEvent(EVENT_HYDRA_SHOT, 28000);
                }
                break;
            case 2:
                Talk(SAY_PHASE_2);
                events.ScheduleEvent(EVENT_BURDEN_OF_PAIN, IsHeroicPlusRaid() ? 26000 : 28000);
                events.ScheduleEvent(EVENT_BECKON_SARUKEL, IsHeroicPlusRaid() ? 40000 : 42000);
                events.ScheduleEvent(EVENT_SUMMON_OSSUNET, 10000);
                callVelliusTimer = {42000, 44000};

                if (IsHeroicRaid())
                {
                    summonOssunetTimer = {42000};
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, 16000);
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, 30000);
                }
                else if (IsMythicRaid())
                {
                    summonOssunetTimer = {42000};
                ...
                else
                {
                    ...
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, 36000);

                    if (!IsLfrRaid())
                        events.ScheduleEvent(EVENT_HYDRA_SHOT, 18000);
                }
                break;
            case 3:
                Talk(SAY_PHASE_3);
                ...
                if (IsHeroicRaid())
                {
                    ...
                    events.ScheduleEvent(EVENT_CONSUMING_HUNGER, 40000);
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, 16000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 58000);
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, 32000);
                }
                else if (IsMythicRaid())
                {
                    ...
                    events.ScheduleEvent(EVENT_CONSUMING_HUNGER, 46000);
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, 16000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 52000);
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, 30000);
                }
                else
                {
                    ...
                    events.ScheduleEvent(EVENT_CONSUMING_HUNGER, 52000);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, 52000);
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, 36000);
    ...
    void SpellHitTarget(Unit* target, SpellInfo const* spell) override
    {
        switch (spell->Id)
        {
            ...
            case SPELL_CONSUMING_HUNGER_FILTER:
                ...
                {
                    me->AddDelayedEvent(200, [summon, target] () -> void
                    {
                        if (summon && target)
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_BURDEN_OF_PAIN:
                    ...
                    events.ScheduleEvent(EVENT_BURDEN_OF_PAIN, phase == 1 ? 28000 : (IsHeroicPlusRaid() ? 30000 : 40000));
                    break;
                case EVENT_HYDRA_SHOT:
                    Talk(SAY_HYDRA_SHOT_WARN);
                    DoCast(me, SPELL_HYDRA_SHOT_FILTER, true);
                    events.ScheduleEvent(EVENT_HYDRA_SHOT, IsMythicRaid() ? 30000 : 40000);
                    break;
                case EVENT_SLICING_TORNADO:
                    Talk(SAY_SLICING_TORNADO);
                    Talk(SAY_SLICING_TORNADO_WARN);
                    DoCast(SPELL_SLICING_TORNADO_FILTER);
                    events.ScheduleEvent(EVENT_SLICING_TORNADO, slicingTornadoTimer.front());
                ...
                case EVENT_THUNDERING_SHOCK:
                    ...
                    events.ScheduleEvent(EVENT_THUNDERING_SHOCK, thunderingShockTimer.front());
                ...
                case EVENT_CONSUMING_HUNGER:
                    ...
                    events.ScheduleEvent(EVENT_CONSUMING_HUNGER, consumingHungerTimer.front());
                ...
                case EVENT_BECKON_SARUKEL:
                {
                    ...
                    events.ScheduleEvent(EVENT_BECKON_SARUKEL, 42000);
                    break;
                }
                case EVENT_SUMMON_OSSUNET:
                    DoCast(SPELL_SUMMON_OSSUNET);
                    events.ScheduleEvent(EVENT_SUMMON_OSSUNET, summonOssunetTimer.front());
                ...
                case EVENT_CALL_VELLIUS:
                    ...
                    events.ScheduleEvent(EVENT_CALL_VELLIUS, callVelliusTimer.front());
...
struct npc_sasszine_abyss_stalker : public ScriptedAI
{
    ...
    {
        if (IsHeroicPlusRaid())
            events.ScheduleEvent(EVENT_1, 10000); //Dark Depths
    }
