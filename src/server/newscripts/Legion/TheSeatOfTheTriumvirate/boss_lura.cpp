...
enum Spells
{
    ...
    SPELL_REMNANT_AT            = 245241, //AT doesnt disapear instantly
...
public:
    ...
    struct boss_luraAI : public BossAI
    {
        ...
        {
            _EnterCombat();
            events.ScheduleEvent(EVENT_BLAST, urand(10000, 18000));
        ...
        void DoAction(int32 const action) override
        {
            ...
            case 1:
                me->AddDelayedEvent(2000, [this] {
                    instance->DoCastSpellOnPlayers(SPELL_INTRO_CONVERS);
                });
            ...
            case 4:
                if (me->isInCombat())
                {
                    ...
                    if (me->GetMap()->GetDifficultyID() == DIFFICULTY_MYTHIC_DUNGEON)
                            events.ScheduleEvent(EVENT_SHIFT, 21000);

                        events.ScheduleEvent(EVENT_CADENCE, 25000);
                }
                break;
            }
        }
        ...
        void UpdateAI(uint32 diff) override 
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_CADENCE:
                    ...
                    events.ScheduleEvent(EVENT_CADENCE, urand(13000, 15000));
                    break;
                }
            }
...
public:
    ...
    struct npc_lura_intro_rift_wardenAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_2, urand(8000,10000));
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_2:
                    ...
                    events.ScheduleEvent(EVENT_2, urand(15000, 17000));
                    break;
                case EVENT_3:
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_1:
                    ...
                    events.ScheduleEvent(EVENT_1, urand(18000, 22000));
                    break;
                case EVENT_2:
                    DoCast(SPELL_SHOCK);
                    events.ScheduleEvent(EVENT_2, urand(10000, 12000));
                    break;
                }
            }
            DoMeleeAttackIfReady();
