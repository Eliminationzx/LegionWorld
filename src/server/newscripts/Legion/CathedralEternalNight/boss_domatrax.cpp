...
public:
    ...
    struct boss_domatraxAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_FELSOUL_CLEAVE, 8000);
            events.ScheduleEvent(EVENT_CHAOTIC_ENERGY, 1000);
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType dmgType) override
        {
            if (phase < 3 && me->HealthBelowPct(phases_hp_required[phase]))
            {
                ...
                {
                    case 0:
                        events.ScheduleEvent(EVENT_WAVE_ONE, 100);
                        break;
                    case 1:
                        events.ScheduleEvent(EVENT_WAVE_TWO, 100);
                        break;
                    case 2:
                        events.ScheduleEvent(EVENT_ENRAGE, 100);
                        break;
                    default:
                        break;
                }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_FELSOUL_CLEAVE:
                        ...
                        events.ScheduleEvent(EVENT_FELSOUL_CLEAVE, 18000);
                        break;
                    case EVENT_CHAOTIC_ENERGY:
                        ...
                        else
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHAOTIC_ENERGY, 5000);
                        }
                        break;
                    case EVENT_WAVE_ONE:
