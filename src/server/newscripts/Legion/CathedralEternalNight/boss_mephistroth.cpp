        ...
        void DefaultEvents(uint8 phase)
        {
            ...
            switch(phase)
            {
                case 1:
                    ...
                    events.ScheduleEvent(EVENT_DEMONIC_UPHEAVAL, 3200);
                    events.ScheduleEvent(EVENT_DARK_SOLITUDE, 8000);
                    events.ScheduleEvent(EVENT_CARRION_SWARM, 15000);
                    break;
                case 2:
                    events.ScheduleEvent(EVENT_PHASE_TWO_TICK, GetDifficultyID() == DIFFICULTY_HEROIC ? 5000 : 4000);
                    break;
            }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_DEMONIC_UPHEAVAL:
                        ...
                        events.ScheduleEvent(EVENT_DEMONIC_UPHEAVAL, 27000);
                        break;
                    case EVENT_DARK_SOLITUDE:
                        DoCast(SPELL_DARK_SOLITUDE);
                        events.ScheduleEvent(EVENT_DARK_SOLITUDE, 12000);
                        break;
                    case EVENT_CARRION_SWARM:
                        DoCastVictim(SPELL_CARRION_SWARM);
                        events.ScheduleEvent(EVENT_CARRION_SWARM, 18000);
                        break;
