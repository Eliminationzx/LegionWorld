...
public:
    ...
    struct boss_trilliaxAI : BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_ARCANE_SLASH, 7000);
            events.ScheduleEvent(EVENT_TOXIC_SLICE, 10000);
        ...
        void OnApplyOrRemoveAura(uint32 spellId, AuraRemoveMode mode, bool apply) override
        {
            ...
            switch (spellId)
            {
                ...
                case SPELL_FORM_CLEANER:
                {
                    ...
                    events.ScheduleEvent(EVENT_ARCANE_SLASH, 7000);
                    events.ScheduleEvent(EVENT_MANA_RUPTURE, 2000);
                    events.ScheduleEvent(EVENT_ARCING_BONDS, 5000);
                ...
                case SPELL_FORM_MANIAC:
                {
                    ...
                    events.ScheduleEvent(EVENT_SUCCULENT_FEAST, 5000);
                    events.ScheduleEvent(EVENT_TIDY_UP, 12000);
                    break;
                }
                case SPELL_FORM_CARETAKER:
                {
                    ...
                    events.ScheduleEvent(EVENT_ARCANE_SLASH, 7000);
                    events.ScheduleEvent(EVENT_TOXIC_SLICE, 10000);
                    events.ScheduleEvent(EVENT_STERILIZE, 1000);
                    events.ScheduleEvent(EVENT_CLEANSING_RAGE, 10000);
                    if (IsMythicRaid())
                    {
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == EFFECT_MOTION_TYPE)
            {
                if (id == SPELL_ANNIHILATION_JUMP)
                {
                    ...
                    events.ScheduleEvent(EVENT_ANNIHILATION, 2500);
                }
            }
        }
                ...
                switch (eventId)
                {
                    case EVENT_ARCANE_SLASH:
                        ...
                        if (me->HasAura(SPELL_FORM_MANIAC))
                            events.ScheduleEvent(EVENT_ARCANE_SLASH, 8000);
                        else
                            events.ScheduleEvent(EVENT_ARCANE_SLASH, 11000);
                        break;
                    ...
                    case EVENT_TOXIC_SLICE:
                        ...
                        events.ScheduleEvent(EVENT_TOXIC_SLICE, 26000);
                        break;
