...
struct boss_skorpyron : BossAI
{
    ...
    void EnterCombat(Unit* /*who*/) override //37:22
    {
        ...
        events.ScheduleEvent(EVENT_CALL_SCORPID, 22000);
        events.ScheduleEvent(EVENT_ARCANOSLASH, 6000);
    }
    ...
    void DoAction(int32 const action) override
    {
        if (action == ACTION_1)
        {
            ...
            events.ScheduleEvent(EVENT_VULNERABILITY, 100);
        }
    }
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_FOCUSED_BLAST:
                    ...
                    events.ScheduleEvent(EVENT_FOCUSED_BLAST, 33000);
                    break;
                case EVENT_CALL_SCORPID:
                    DoCast(me, SPELL_CALL_SCORPID, true);
                    events.ScheduleEvent(EVENT_CALL_SCORPID, 20000);
                    break;
                ...
                case EVENT_ARCANOSLASH:
                    ...
                    events.ScheduleEvent(EVENT_ARCANOSLASH, 10000);
                    break;
            }
        }
