    ...
    class spell_vantus_rune_the_nighthold_AuraScript : public AuraScript
    {
        ...
        void OnUpdate(uint32 diff, AuraEffect* /*aurEff*/)
        {
            ...
            if (checkOnProc <= diff)
            {
                ...
                {
                    if (!player->HasAura(208850) && player->HasAura(192767))
                    {
                ...
                {
                    if (!player->HasAura(208851) && player->HasAura(192768))
                    {
                        player->CastSpell(player, 208851, false);
                    }
                }
                if (instance->GetBossState(DATA_TRILLIAX) == IN_PROGRESS)
                {
                    if (!player->HasAura(208852) && player->HasAura(192769))
                    {
                ...
                {
                    if (!player->HasAura(208853) && player->HasAura(192770))
                    {
                ...
                {
                    if (!player->HasAura(208857) && player->HasAura(192774))
                    {
                ...
                {
                    if (!player->HasAura(208855) && player->HasAura(192772))
                    {
                        player->CastSpell(player, 208855, false);
                    }
                }
                if (instance->GetBossState(DATA_KROSUS) == IN_PROGRESS)
                {
                    if (!player->HasAura(208856) && player->HasAura(192773))
                    {
                        player->CastSpell(player, 208856, false);
                    }
                }
                if (instance->GetBossState(DATA_TICHONDRIUS) == IN_PROGRESS)
                {
                    if (!player->HasAura(208854) && player->HasAura(192771))
                    {
                        player->CastSpell(player, 208854, false);
                    }
                }
                if (instance->GetBossState(DATA_ELISANDE) == IN_PROGRESS)
                {
                    if (!player->HasAura(208858) && player->HasAura(192775))
                    {
                        player->CastSpell(player, 208858, false);
                    }
                }
                if (instance->GetBossState(DATA_GULDAN) == IN_PROGRESS)
                {
                    if (!player->HasAura(208859) && player->HasAura(192776))
                    {
            ...
            if (checkOnRemove <= diff)
            {
                ...
                if (player->HasAura(208856) && player->HasAura(192774))
                {
                ...
                if (player->HasAura(208858) && player->HasAura(192776))
                {
