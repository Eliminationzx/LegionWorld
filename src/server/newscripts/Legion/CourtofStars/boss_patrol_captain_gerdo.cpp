...
public:
    ...
    struct boss_patrol_captain_gerdoAI : public BossAI
    {
        ...
        //06:03
        {
            ...
            events.ScheduleEvent(EVENT_RESONANT_SLASH, 7000);   //06:10, 06:32, 06:44
            events.ScheduleEvent(EVENT_ARCANE_LOCKDOWN, 15000); //06:18, 06:52, 07:20
            events.ScheduleEvent(EVENT_SIGNAL_BEACON, 23000);   //06:26
