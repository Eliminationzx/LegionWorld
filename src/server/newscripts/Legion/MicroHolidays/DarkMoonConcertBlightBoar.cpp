...
{
    { -4169.229f, 6052.789f, 6.260829f },
    { -4172.854f, 6054.479f, 6.260829f },
    { -4167.416f, 6051.943f, 6.260829f },
    { -4165.604f, 6051.098f, 6.260829f },
    { -4163.791f, 6050.253f, 6.260829f },
    { -4175.737f, 5996.241f, 6.260829f },
    { -4173.925f, 5995.396f, 6.260829f },
    { -4172.112f, 5994.551f, 6.260829f },
    { -4181.175f, 5998.777f, 6.260829f },
    { -4179.362f, 5997.932f, 6.260829f },
    { -4177.55f, 5997.086f, 6.260829f },
    { -4170.3f, 5993.706f, 6.260829f },
    { -4184.8f, 6000.467f, 6.260829f },
    { -4197.487f, 6006.384f, 6.260829f },
    { -4199.3f, 6007.229f, 6.260829f },
    { -4201.112f, 6008.074f, 6.260829f },
    { -4202.925f, 6008.919f, 6.260829f },
    { -4204.737f, 6009.765f, 6.260829f },
    { -4195.675f, 6005.539f, 6.260829f },
    { -4206.55f, 6010.61f, 6.260829f }
};
...
struct npc_jay_maguire : public ScriptedAI
{
    ...
    {
        events.Reset();
        events.ScheduleEvent(EVENT_PREPARE_30_MIN, 1000);
        events.ScheduleEvent(EVENT_PREPARE_20_MIN, 1000);
        events.ScheduleEvent(EVENT_PREPARE_10_MIN, 1000);
        events.ScheduleEvent(EVENT_PREPARE_1_MIN, 1000);
        events.ScheduleEvent(EVENT_STARTED, 1000);
        finishwp = false;
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_READY:
            {
                ...
                events.ScheduleEvent(EVENT_ENDED, 312000);
                break;
            }
            case EVENT_ENDED:
                me->SetUInt32Value(UNIT_FIELD_EMOTE_STATE, EMOTE_STATE_READ);
            ...
            if (finishwp && me->IsSplineFinished())
            {
                ...
                events.ScheduleEvent(EVENT_READY, 4000);
            }
        }
    }
};
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_START_CONCERT:
                ...
                events.ScheduleEvent(EVENT_END_CONCERT, 312300);
                break;
        ...
        {
            startEvent = true;
            events.ScheduleEvent(EVENT_START_CONCERT, 18000);
        }
    }
};
...
struct npc_death_metal_knight : public ScriptedAI
{
    ...
    {
        DoCast(me, SPELL_COLD_AS_ICE);
        events.ScheduleEvent(EVENT_BANSHEE_AT, 27000);
    }
    ...
    void IsSummonedBy(Unit* owner) override
    {
        ...
        {
            introDone = true;
            DoCast(me, SPELL_GRAND_ENTRANCE);
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType dmgType) override
    {
        if (!me->HealthAbovePct(28) && !army)
        {
            ...
            {
                army = true;
                events.ScheduleEvent(EVENT_ARMY_OF_THE_DEAD, 1000);
            }
        }
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            ...
            /*case EVENT_BANSHEE_AT:
                ...
                events.ScheduleEvent(EVENT_BANSHEE_AT, 25000);
                break;*/
            case EVENT_ARMY_OF_THE_DEAD:
                ...
                events.ScheduleEvent(EVENT_ARMY_OF_THE_DEAD, 25000);
                break;
            }
        }
...
struct npc_darkmoon_ghoul : public ScriptedAI
{
    ...
    void IsSummonedBy(Unit* owner) override
    {
        DoCast(me, SPELL_DEATHLY_PALLOR);
        DoCast(me, SPELL_DEATHS_ADVANCE);

        if (Creature* styx = me->FindNearestCreature(NPC_DEVLYNN_STYX, 100.0f, true))
        {
...
struct npc_devlynn_styx : public ScriptedAI
{
    ...
    {
        events.Reset();
        events.ScheduleEvent(EVENT_JUMP_SCREAM, 120000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_JUMP_SCREAM:
            {
                ...
                events.ScheduleEvent(EVENT_WHOOOOOOAH, 13000);
                Talk(SAY_DEVLYNN_STYX_SCREAM);
                me->AddDelayedEvent(1000, [=]() -> void
                {
                    DoCast(SPELL_IN_THE_CROWD);
                });
                break;
            }
            case EVENT_WHOOOOOOAH:
                ...
                events.ScheduleEvent(EVENT_WHOOOOOOAH, 25000);
                break;
            }
        }
    }
