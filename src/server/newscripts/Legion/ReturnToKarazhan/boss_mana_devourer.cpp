...
public:
    ...
    struct boss_mana_devourerAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_ARCANE_BOMB, 8000);
            events.ScheduleEvent(EVENT_ENERGY_VOID, 15000);
            events.ScheduleEvent(EVENT_ENERGY_DISCHARGE, 22000);
            events.ScheduleEvent(EVENT_COALESCE_POWER, 30000);
        }
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (GetDifficultyID() != DIFFICULTY_MYTHIC_DUNGEON)
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_ARCANE_BOMB:
                        ...
                        events.ScheduleEvent(EVENT_ARCANE_BOMB, 14000);
                        break;
                    case EVENT_ENERGY_VOID:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ENERGY_VOID, 22000);
                        break;
                    }
                    case EVENT_ENERGY_DISCHARGE:
                        ...
                        events.ScheduleEvent(EVENT_ENERGY_DISCHARGE, 27000);
                        break;
