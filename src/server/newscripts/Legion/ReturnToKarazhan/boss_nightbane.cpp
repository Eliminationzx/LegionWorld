...
public:
    ...
    struct boss_rtk_nightbaneAI : public BossAI
    {
        ...
        void DefaultEvents(uint8 phase)
        {
            ...
            {
                case 2:
                events.ScheduleEvent(EVENT_ROAR, 20000);
                // no break
                case 1:
                events.ScheduleEvent(EVENT_CINDER_BREATH, 8000); 
                events.ScheduleEvent(EVENT_IGNITE_SOUL, 20000); 
                events.ScheduleEvent(EVENT_REVERBERATING_SHADOWS, 17000); 
                events.ScheduleEvent(EVENT_CHARRED_GROUND, 3000); 
                events.ScheduleEvent(EVENT_BURNING, 19000);
                events.ScheduleEvent(EVENT_TAIL, 12000);
                
                events.ScheduleEvent(EVENT_POWER, 30000 );
                events.ScheduleEvent(EVENT_POWER_1, 53000);
                break;
            }
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_CINDER_BREATH:
                        ...
                        events.ScheduleEvent(EVENT_CINDER_BREATH, 20000);
                        break;
                    case EVENT_IGNITE_SOUL:
                        ...
                        events.ScheduleEvent(EVENT_IGNITE_SOUL, 25000);
                        break;
                    case EVENT_REVERBERATING_SHADOWS:
                        DoCast(SPELL_REVERBERATING_SHADOWS);
                        events.ScheduleEvent(EVENT_REVERBERATING_SHADOWS, 13000);
                        break;
                    case EVENT_BURNING:
                        DoCast(SPELL_BURNING_BONES);
                        Talk(SAY_BURNING);
                        events.ScheduleEvent(EVENT_BURNING, 18000);
                        break;
                    case EVENT_TAIL:
                    ...
                    case EVENT_ROAR:
                        ...
                        Talk(SAY_ROAR);
                        events.ScheduleEvent(EVENT_ROAR, 42000);
                        break;
