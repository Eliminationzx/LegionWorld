    ...
    struct npc_rtk_barnes_encounter_starterAI : public ScriptedAI
    {
        ...
        void sGossipSelect(Player* player, uint32 sender, uint32 action) override
        {
            ...
            //> DEBUG!!!
                ...
                //return;
            //< DEBUG!!!
                events.ScheduleEvent(EVENT_START_TALK, 1 * IN_MILLISECONDS);

                switch (instance->GetData(DATA_OPERA_HALL_SCENE))
                {
                    case DATA_OPERA_HALL_WIKKET:
                        events.ScheduleEvent(EVENT_WIKKET_1, 10 * IN_MILLISECONDS);
                        break;
                    case DATA_OPERA_HALL_WESTFALL:
                        events.ScheduleEvent(EVENT_WESTFALL, 10 * IN_MILLISECONDS);
                        break;
                    case DATA_OPERA_HALL_BEAUTIFUL_BEAST:
                        events.ScheduleEvent(EVENT_BEAUTIFUL_BEAST, 10 * IN_MILLISECONDS);
                        break;
                    default:
                        break;
                }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == POINT_MOTION_TYPE)
            {
                if (id == 1)
                {
                    ...
                    events.ScheduleEvent(EVENT_TELEPORT, 1 * IN_MILLISECONDS);
                }
            }
        }
        ...
        void TextEvent(uint32 spotlightTimer, uint8 textIdx)
        {
            ...
            events.ScheduleEvent(EVENT_END_TALK, (westfall ? 38 : 44) * IN_MILLISECONDS);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_WIKKET_1:
                        ...
                        TextEvent(5000, 0);
                        events.ScheduleEvent(EVENT_WIKKET_2, 1 * IN_MILLISECONDS);
                        break;
                    case EVENT_WIKKET_2:
                        Talk(1); // Welcome, ladies and gentlemen, to our--OOF!
                        events.ScheduleEvent(EVENT_WIKKET_3, 4 * IN_MILLISECONDS);
                        break;
                    case EVENT_WIKKET_3:
    ...
    struct boss_rtk_galindreAI : public boss_opera_encounters
    {
        ...
        void Reset() override
        {
            ...
            if (instance->GetData(DATA_OPERA_HALL_INTRO) != IN_PROGRESS)
            {
                ...
                events.ScheduleEvent(EVENT_WIK_GALINDRE_1, 500);
                events.ScheduleEvent(EVENT_WIK_GALINDRE_2, 12000);
            }
        }
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_WIK_GALINDRE_AGGRO_TALK, 3000);
            events.ScheduleEvent(EVENT_WIK_GALINDRE_FLASHY_BOLT, 1000);
            events.ScheduleEvent(EVENT_WIK_GALINDRE_WONDROUS_RADIANCE, 8000);
            events.ScheduleEvent(EVENT_WIK_GALINDRE_MAGIC_MAGNIFICENT, 48000);
        }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == EFFECT_MOTION_TYPE)
            {
                if (id == 1)
                {
                    ...
                    events.ScheduleEvent(EVENT_WIK_GALINDRE_3, 6000);
                }
            }
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_WIK_GALINDRE_3:
                        ...
                        events.ScheduleEvent(EVENT_WIK_GALINDRE_4, 10000);
                        break;
                    ...
                    case EVENT_WIK_GALINDRE_FLASHY_BOLT:
                        ...
                        events.ScheduleEvent(EVENT_WIK_GALINDRE_FLASHY_BOLT, 4000);
                        break;
                    case EVENT_WIK_GALINDRE_WONDROUS_RADIANCE:
                        DoCastVictim(SPELL_WONDROUS_RADIANCE);
                        events.ScheduleEvent(EVENT_WIK_GALINDRE_WONDROUS_RADIANCE, 10000);
                        break;
...
public:
    ...
    struct boss_rtk_elfyraAI : public boss_opera_encounters
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_WIK_ELFYRA_DREARY_BOLT, 4000);
            events.ScheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS, 30000);
            events.ScheduleEvent(EVENT_WIK_ELFYRA_DEFY_GRAVITY, 11000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_WIK_ELFYRA_SUM_ASSISTANTS:
                        ...
                        events.ScheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS, 32000);
                        events.ScheduleEvent(EVENT_WIK_ELFYRA_SUM_ASSISTANTS_2, 1000);
                        break;
                    ...
                    case EVENT_WIK_ELFYRA_DEFY_GRAVITY:
                        ...
                        events.ScheduleEvent(EVENT_WIK_ELFYRA_DEFY_GRAVITY, 19000);
                        break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_toe_kneeAI : public boss_opera_encounters
    {
        ...
        void RunEvents()
        {
            events.ScheduleEvent(EVENT_TOE_BURNING_LEG_SWEEP, 10000);
            events.ScheduleEvent(EVENT_TOE_DASHING_FLAME_GALE, 22000);
        }
        ...
        void SpellHitTarget(Unit* target, const SpellInfo* spell) override
        {
            switch (spell->Id)
            {
                ...
                case SPELL_DASHING_FLAME_GALE_CHARGE:
                    ...
                    events.ScheduleEvent(EVENT_TOE_DASHING_FLAME_GALE_CHARGE, 100);
                    break;
            }
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_TOE_BURNING_LEG_SWEEP:
                        ...
                        events.ScheduleEvent(EVENT_TOE_BURNING_LEG_SWEEP, 20000);
                        break;
                    case EVENT_TOE_DASHING_FLAME_GALE:
                        Talk(SAY_TOE_FLAME_GALE);
                        DoCast(SPELL_DASHING_FLAME_GALE);
                        events.ScheduleEvent(EVENT_TOE_DASHING_FLAME_GALE, 30000);
                        events.ScheduleEvent(EVENT_TOE_DASHING_FLAME_GALE_CHARGE, 100);
                        break;
...
public:
    ...
    struct boss_rtk_mrrgriaAI : public boss_opera_encounters
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_MRRG_THUNDER_RITUAL, 8000);
            events.ScheduleEvent(EVENT_MRRG_WASH_AWAY, 16000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_MRRG_THUNDER_RITUAL:
                        ...
                        events.ScheduleEvent(EVENT_MRRG_THUNDER_RITUAL, 18000);
                        break;
                    case EVENT_MRRG_WASH_AWAY:
                        DoCast(SPELL_WASH_AWAY_FILTER);
                        events.ScheduleEvent(EVENT_MRRG_WASH_AWAY, 23000);
                        break;
                }
            }
            DoMeleeAttackIfReady();
            ...
            if (action == ACTION_3)
            {
                ...
                if (diedCountBB == 2)
                {
                    if (Creature* coggleston = instance->instance->GetCreature(instance->GetGuidData(NPC_COGGLESTON)))
                    {
                        ...
                        events.ScheduleEvent(EVENT_COGGLESTON_DENT_ARMOR, 9000);
                        events.ScheduleEvent(EVENT_SUMMON_HELPERS, 2000);
                        events.ScheduleEvent(EVENT_DINNER_BELL, 12000);
                    }
                }
                diedCountBB++;
            }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_DINNER_BELL:
                        ...
                        events.ScheduleEvent(EVENT_DINNER_BELL, 20000);
                        break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_luminoreAI : public boss_opera_encounters
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 2000);
            events.ScheduleEvent(EVENT_LUMINORE_HEAT_WAVE, 30000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_LUMINORE_BURNING_BLAZE:
                        ...
                        {
                            castCount = 0;
                            events.ScheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 9000);
                        }
                        else
                            events.ScheduleEvent(EVENT_LUMINORE_BURNING_BLAZE, 3000);
                        break;
...
public:
    ...
    struct boss_rtk_babbletAI : public boss_opera_encounters
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_BABBLET_FIXATE, 1000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_BABBLET_FIXATE:
                        ...
                        events.ScheduleEvent(EVENT_BABBLET_FIXATE, 11000);
                        events.ScheduleEvent(EVENT_BABBLET_FOLLOW_TARGET, 1000);
                        break;
                    case EVENT_BABBLET_FOLLOW_TARGET:
                        ...
                        events.ScheduleEvent(EVENT_BABBLET_FOLLOW_TARGET, 500);
                        break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct boss_rtk_cauldronsAI : public boss_opera_encounters
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_CAULDRON_SOUP_SPRAY, 1000);
            events.ScheduleEvent(EVENT_CAULDRON_LEFTOVERS, 8000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_CAULDRON_SOUP_SPRAY:
                        ...
                        events.ScheduleEvent(EVENT_CAULDRON_SOUP_SPRAY, 3000);
                        break;
                    case EVENT_CAULDRON_LEFTOVERS:
                        if (urand(0, 1))
                            Talk(SAY_CAULDRONS_LEFTOVERS);
                        DoCast(SPELL_LEFTOVERS);
                        events.ScheduleEvent(EVENT_CAULDRON_LEFTOVERS, 18000);
                        break;
                }
            }
            DoMeleeAttackIfReady();
