...
public:
    ...
    struct boss_shade_of_medivhAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_ALTERNATING_ABILITY, 500);
        }
            ...
            if (action == ACTION_1 && !specialAbility)
            {
                ...
                switch (urand(0, 2))
                {
                    case 0: //Special Frost
                        events.ScheduleEvent(EVENT_SPECIAL_FROST, 500);
                        break;
                    case 1: //Special Fire
                        events.ScheduleEvent(EVENT_SPECIAL_FIRE, 500);
                        break;
                    case 2: //Special Arcane
                        events.ScheduleEvent(EVENT_SPECIAL_ARCANE, 500);
                        break;
                }
            }
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_ALTERNATING_ABILITY:
                        CastDefAbility();
                        events.ScheduleEvent(EVENT_ALTERNATING_ABILITY, 4000);
                        break;
