...
public:
    ...
    struct boss_rtk_moroesAI : public BossAI
    {
        ...
        //41:14
        {
            ...
            events.ScheduleEvent(EVENT_VANISH, 7000); //41:21, 41:42 42:02
            events.ScheduleEvent(EVENT_COAT_CHECK, 30000); //41:44 42:20
        }
        ...
        //41:14
        {
            ...
            switch (me->GetEntry())
            {
                case NPC_BARONESS_DOROTHEA:
                    events.ScheduleEvent(EVENT_1, 1000); //41:15
                    events.ScheduleEvent(EVENT_2, 9000); //41:23
                    break;
                case NPC_LADY_CATRIONA:
                    ...
                    break;
                case NPC_BARON_RAFE:
                    events.ScheduleEvent(EVENT_5, 5000); //41:19
                    break;
                case NPC_LADY_KEIRA:
                ...
                case NPC_LORD_CRISPIN:
                    events.ScheduleEvent(EVENT_8, 11000); //41:25
                    break;
            }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_6:
                        ...
                        events.ScheduleEvent(EVENT_6, 12000);
                        break;
                    case EVENT_7:
                        ...
                        events.ScheduleEvent(EVENT_7, 18000);
                        break;
                    case EVENT_8:
                        if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 80.0f, true))
                        {
                        ...
                        events.ScheduleEvent(EVENT_8, 18000);
                        break;
                }
            }
            DoMeleeAttackIfReady();
