    ...
    struct boss_lady_hatecoilAI : public BossAI
    {
        ...
        //51:13 | 21:06 (heroic)
        {
            ...
            if (me->GetMap()->GetDifficultyID() != DIFFICULTY_NORMAL)
                events.ScheduleEvent(EVENT_MONSOON, 32000); //21:38, 21:59 | 22:14, 22:35, 22:57, 23:18, 23:38
        }
        ...
        void SummonNagas()
        {
            for (uint8 i = 0; i < 3; i++)
            {
                me->SummonCreature(97171, nagPos[i]);
                if (i < 2)
                    DoCast(me, 197868, true);
            }
        }
        ...
        void SummonedCreatureDies(Creature* summon, Unit* /*killer*/) override
        {
            ...
            if (nagaDiedCount == 2)
            {
                me->RemoveAurasDueToSpell(197868);
