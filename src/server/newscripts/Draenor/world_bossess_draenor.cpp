...
public:
    ...
    struct boss_drovAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* unit)
        {
            ...
            events.ScheduleEvent(EVENT_3, 90000);
            events.ScheduleEvent(EVENT_4, 45000);
        }
...
public:
    ...
    struct boss_tarlnaAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* unit)
        {
            ...
            events.ScheduleEvent(EVENT_2, 36000);
            events.ScheduleEvent(EVENT_3, 26000); // 16
            events.ScheduleEvent(EVENT_4, 49000); 
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_2:
                        ...
                        events.ScheduleEvent(EVENT_2, 46000);
                        break;
                    case EVENT_3:
                        DoCast(SPELL_SAVAGE_VINES);
                        events.ScheduleEvent(EVENT_3, 16000); // 16
                        break;
                    case EVENT_4:
...
public:
    ...
    struct boss_ruhamarAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* unit)
        {
            ...
            events.ScheduleEvent(EVENT_1, 12000, EVENT_GROUP_GROUND);
            events.ScheduleEvent(EVENT_2, 29000, EVENT_GROUP_GROUND);
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType dmgType)
        {
            ...
            {
                healthPct -= urand(2,4);
                events.ScheduleEvent(EVENT_4, 10, EVENT_GROUP_GROUND);
            }
        }
...
public:
    ...
    struct boss_kazzak_legionAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* unit)
        {
            ...
            events.ScheduleEvent(EVENT_2, 23000);
            events.ScheduleEvent(EVENT_3, 52000);
        }
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType dmgType)
        {
            ...
            {
                healthPct -= 33;
                events.ScheduleEvent(EVENT_4, 10);
            }
        }     
