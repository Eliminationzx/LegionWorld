...
public:
    ...
    struct auchindoun_mob_sargerei_soulbinderAI : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EventMindShear, 8 * IN_MILLISECONDS);
            events.ScheduleEvent(EventBendWill, 18 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventMindShear:
                    ...
                    events.ScheduleEvent(EventBendWill, 8 * IN_MILLISECONDS);
                    break;
                case EventBendWill:
                    if (Unit* l_Target = SelectTarget(SELECT_TARGET_RANDOM, 0, 50.0f, true))
...
public:
    ...
    struct auchindoun_mob_sargerei_clericAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            events.ScheduleEvent(eSargereiClericEvents::EventVoidShell, 15 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eSargereiClericEvents::EventVoidShell:
                    ...
                    events.ScheduleEvent(eSargereiClericEvents::EventVoidShell, urand(12 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_mob_sargerei_ritualistAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            me->CastStop();
            me->RemoveAllAuras();
            events.ScheduleEvent(eSargereiRitualistEvents::EventMindSpike, urand(6 * IN_MILLISECONDS, 8 * IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eSargereiRitualistEvents::EventMindSpike:
                    ...
                    events.ScheduleEvent(eSargereiRitualistEvents::EventMindSpike, 6 * IN_MILLISECONDS);
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_mob_sargerei_zealotAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eAuchindounEvents::EventSeverTendom, 5 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eAuchindounEvents::EventSeverTendom:
                    ...
                    events.ScheduleEvent(eAuchindounEvents::EventSeverTendom, urand(9 * IN_MILLISECONDS, 14 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_mob_sargerei_spirit_tenderAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eSpiritTenderEvents::EventVoidMending, 10 * IN_MILLISECONDS);
            events.ScheduleEvent(eSpiritTenderEvents::EventVoidShift, 16 * IN_MILLISECONDS);
        }
...
public:
    ...
    struct auchindoun_mob_sargerei_hopiliteAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eSargereiHopiliteEvents::EventShieldBash, urand(8 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
            events.ScheduleEvent(eSargereiHopiliteEvents::EventVoidStrikes, 18 * IN_MILLISECONDS);
        }
...
public:
    ...
    struct auchindoun_mob_sargerei_defenderAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eSargereiDefenderEvents::EventAvengersShield, urand(10 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
            events.ScheduleEvent(eSargereiDefenderEvents::EventCrusaderStirke, urand(5 * IN_MILLISECONDS, 9 * IN_MILLISECONDS));
        }
...
public:
    ...
    struct auchindoun_mob_sargerei_magusAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            ...
            events.ScheduleEvent(eSargereiMagusEvents::EventArcaneBomb, 13 * IN_MILLISECONDS);
            events.ScheduleEvent(eSargereiMagusEvents::EventArcaneBolt, 20 * IN_MILLISECONDS);
...
public:
    ...
    struct auchindoun_mob_soul_priestAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eSoulPriestEvents::EventPsychicTerrors, 15 * IN_MILLISECONDS);
            events.ScheduleEvent(eSoulPriestEvents::EventShadowWordPainSoulPriest, urand(8 * IN_MILLISECONDS, 10 * IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eSoulPriestEvents::EventShadowWordPainSoulPriest:
                    ...
                    events.ScheduleEvent(eSoulPriestEvents::EventShadowWordPainSoulPriest, urand(8 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
                    break;
...
public:
    ...
    struct auchindoun_mob_sargeri_wardenAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eWardenEvents::EventWardenChain, 5 * IN_MILLISECONDS);
            events.ScheduleEvent(eWardenEvents::EventWardenHammer, urand(12 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case eWardenEvents::EventWardenChain:
                    ...
                    events.ScheduleEvent(eWardenEvents::EventWardenChain, 20 * IN_MILLISECONDS);
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_mob_felborne_abyssalAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eFelborneAbyssalEvents::EventFixate, urand(16 * IN_MILLISECONDS, 20 * IN_MILLISECONDS));
        }
...
public:
    ...
    struct auchindoun_mob_cackling_pyromaniacAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eCacklingPyromaniacEvents::EventFelBlast, 6 * IN_MILLISECONDS);
        }
...
public:
    ...
    struct auchindoun_mob_blazing_tricksterAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            events.ScheduleEvent(eBlazingTricksterEvents::EventConfligrate, urand(8 * IN_MILLISECONDS, 15 * IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eBlazingTricksterEvents::EventConfligrate:
                    ...
                    events.ScheduleEvent(eBlazingTricksterEvents::EventConfligrate, urand(8 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_mob_felguardAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* atacker) override
        {
            events.ScheduleEvent(eFelguardEvents::EventFelStomp, 10 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case eFelguardEvents::EventFelStomp:
                    ...
                    events.ScheduleEvent(eFelguardEvents::EventFelStomp, urand(12 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
