...
public:
    ...
    struct boss_teronogorAI : BossAI
    {
                ...
                case ActionChoosePower:
                {
                    ...
                    switch (urand(TransformationAffliction, TransformationDemonology))
                    {
                        case TransformationAffliction: // Mender Elum - Affliction
                            ...
                            events.ScheduleEvent(EventShadowBolt, urand(8 * IN_MILLISECONDS, 10 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventCurseOfExhaustion, 13 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventSeedOfMalevolence, urand(22 * IN_MILLISECONDS, 25 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventAgony, 16 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventDrainLife, urand(13 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventUnstableAffliction, 20 * IN_MILLISECONDS);
                        ...
                        case TransformationDestruction: // Arcanist Jorra's - destruction
                            ...
                            events.ScheduleEvent(EventChaosBolt, 20 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventImmolate, urand(10 * IN_MILLISECONDS, 14 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventConflagrate, urand(8 * IN_MILLISECONDS, 10 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventRainOfFire, 24 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventIncinrate, 16 * IN_MILLISECONDS);
                        ...
                        case TransformationDemonology: // Vindication Iruun's - demonology
                            ...
                            events.ScheduleEvent(EventDoom, urand(8 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventDemonicLeap, urand(10 * IN_MILLISECONDS, 14 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventCurseOfExhaustion, 18 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventCorruption, urand(10 * IN_MILLISECONDS, 14 * IN_MILLISECONDS));
                            events.ScheduleEvent(EventChaosBolt, 25 * IN_MILLISECONDS);
                            events.ScheduleEvent(EventTouchOfChaos, 16 * IN_MILLISECONDS);
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EventShadowBolt, urand(8 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
            events.ScheduleEvent(EventCorruption, urand(10 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
            events.ScheduleEvent(EventRainOfFire, 21 * IN_MILLISECONDS);
            events.ScheduleEvent(EventDrainLife, 16 * IN_MILLISECONDS);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventShadowBolt:
                {
                    ...
                    events.ScheduleEvent(EventShadowBolt, 6 * IN_MILLISECONDS);
                    break;
                }
                case EventCorruption:
                {
                    ...
                    events.ScheduleEvent(EventCorruption, 9 * IN_MILLISECONDS);
                    break;
                }
                case EventDrainLife:
                {
                ...
                case EventImmolate:
                {
                    ...
                    events.ScheduleEvent(EventImmolate, 12 * IN_MILLISECONDS);
                    break;
                }
                case EventConflagrate:
                {
                    ...
                    events.ScheduleEvent(EventConflagrate, urand(15 * IN_MILLISECONDS, 20 * IN_MILLISECONDS));
                    break;
                }
                case EventIncinrate:
                {
                    ...
                    events.ScheduleEvent(EventIncinrate, 6 * IN_MILLISECONDS);
                    break;
                }
                case EventRainOfFire:
                    ...
                    events.ScheduleEvent(EventRainOfFire, 10 * IN_MILLISECONDS);
                    break;
                case EventDoom:
                {
                    if (Unit* l_Random = SelectTarget(SELECT_TARGET_RANDOM, 0, 50.0f, true))
                ...
                case EventDemonicLeap:
                {
                    ...
                    events.ScheduleEvent(EventDemonicLeap, urand(18 * IN_MILLISECONDS, 30 * IN_MILLISECONDS));
                    break;
                }
                case EventChaosWave:
                {
                    ...
                    events.ScheduleEvent(EventChaosWave, urand(8 * IN_MILLISECONDS, 10 * IN_MILLISECONDS));
                    break;
                }
...
public:
    ...
    struct auchindoun_teronogor_mob_duragAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            ...
            events.ScheduleEvent(EventShadowBolt, 6 * IN_MILLISECONDS);
            events.ScheduleEvent(EventCorruption, 9 * IN_MILLISECONDS);
            events.ScheduleEvent(EventChaosWave, 12 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EventChaosWave:
                    if (Unit* l_Target = me->getVictim())
                        me->CastSpell(l_Target, SpellChaosWaveDummy);
                    events.ScheduleEvent(EventChaosWave, 20 * IN_MILLISECONDS);
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_teronogor_mob_gulkoshAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            ...
            me->RemoveAllAuras();
            events.ScheduleEvent(EventShadowBolt, 6 * IN_MILLISECONDS);
            events.ScheduleEvent(EventUnstableAffliction, 8 * IN_MILLISECONDS);
            events.ScheduleEvent(EventDrainLife, 10 * IN_MILLISECONDS);
        }
...
public:
    ...
    struct auchindoun_teronogor_mob_shaadumAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            events.ScheduleEvent(EventWrathcleave, 10 * IN_MILLISECONDS);
            events.ScheduleEvent(EventWrathstorm, urand(14 * IN_MILLISECONDS, 16 * IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventWrathstorm:
                    ...
                    events.ScheduleEvent(EventWrathstorm, urand(8 * IN_MILLISECONDS, 10 * IN_MILLISECONDS));
                    break;
                case EventWrathcleave:
                    if (Unit* l_Random = SelectTarget(SELECT_TARGET_RANDOM, 0, 50.0f, true))
                        me->CastSpell(l_Random, SpellWrathCleave);
                    events.ScheduleEvent(EventWrathcleave, urand(10 * IN_MILLISECONDS, 14 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_teronogor_mob_gromkashAI : ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            me->CastStop();
            me->RemoveAllAuras();
            events.ScheduleEvent(EventImmolate, 8 * IN_MILLISECONDS);
            events.ScheduleEvent(EventIncinrate, urand(10 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
            events.ScheduleEvent(EventRainOfFire, 18 * IN_MILLISECONDS);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventImmolate:
                    ...
                    events.ScheduleEvent(EventImmolate, 10 * IN_MILLISECONDS);
                    break;
                case EventIncinrate:
                    if (Unit* l_Random = SelectTarget(SELECT_TARGET_RANDOM, 0, 50.0f, true))
                ...
                case EventRainOfFire:
                    ...
                    events.ScheduleEvent(EventRainOfFire, 15 * IN_MILLISECONDS);
                    break;
                default:
                    break;
            }
