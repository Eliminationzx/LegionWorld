...
public:
    ...
    struct boss_nyamiAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            Talk(NyamiAggro);
            events.ScheduleEvent(EventMindSpikeNyami, urand(8 * IN_MILLISECONDS, 15 * IN_MILLISECONDS));
            events.ScheduleEvent(EventShadowWordPain, urand(12 * IN_MILLISECONDS, 18 * IN_MILLISECONDS));
            events.ScheduleEvent(EventSoulVessel, 20 * IN_MILLISECONDS);
            events.ScheduleEvent(EventTornSpirit, 35 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventMindSpikeNyami:
                    ...
                    events.ScheduleEvent(EventMindSpikeNyami, urand(6 * IN_MILLISECONDS, 8 * IN_MILLISECONDS));
                    break;
                ...
                case EventSoulVessel:
                    ...
                    events.ScheduleEvent(EventSoulVessel, 25 * IN_MILLISECONDS);
                    break;
                case EventTornSpirit:
                {
                    ...
                    events.ScheduleEvent(EventTornSpiritsDummy, 3 * IN_MILLISECONDS);
                    events.ScheduleEvent(EventTornSpirit, 35 * IN_MILLISECONDS);
                    break;
                }
...
public:
    ...
    struct auchindoun_nyami_mob_malefic_defenderAI : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EventCrusaderStirke, 5 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventCrusaderStirke:
                    ...
                    events.ScheduleEvent(EventCrusaderStirke, urand(7 * IN_MILLISECONDS, 12 * IN_MILLISECONDS));
                    break;
                default:
                    break;
            }
...
public:
    ...
    struct auchindoun_nyami_mob_spiteful_arbitrerAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            events.ScheduleEvent(EventRadiantFury, 8 * IN_MILLISECONDS);
            events.ScheduleEvent(EventArbitrerHammer, 14 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EventRadiantFury:
                {
                    ...
                    events.ScheduleEvent(EventRadiantFuryStop, 6 * IN_MILLISECONDS);
                    break;
                }
                case EventRadiantFuryStop:
                {
                    ...
                    events.ScheduleEvent(EventRadiantFury, urand(15 * IN_MILLISECONDS, 20 * IN_MILLISECONDS));
                    break;
                }
                default:
                    break;
...
public:
    ...
    struct auchindoun_nyami_mob_twisted_magusAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*atacker*/) override
        {
            events.ScheduleEvent(EventArcaneBolt, 4 * IN_MILLISECONDS);
            events.ScheduleEvent(EventArcaneBomb, 12 * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EventArcaneBolt:
                    ...
                    events.ScheduleEvent(EventArcaneBolt, 15 * IN_MILLISECONDS);
                    break;
                case EventArcaneBomb:
                    me->CastSpell(me, SpellArcaneBombDummy);
                    events.ScheduleEvent(EventArcaneBomb, 25 * IN_MILLISECONDS);
                    break;
                default:
                    break;
            }
