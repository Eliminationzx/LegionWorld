...
struct npc_highmaul_gorian_guardsman : public MS::AI::CosmeticAI
{
    ...
    {
        m_Events.ScheduleEvent(EventBloodyCleave, urand(4000, 7000));
        m_Events.ScheduleEvent(EventChainGrip, urand(3000, 8000));
        m_Events.ScheduleEvent(EventStaggeringBlow, urand(6000, 10000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventBloodyCleave:
                ...
                m_Events.ScheduleEvent(EventBloodyCleave, urand(10000, 15000));
                break;
            case EventChainGrip:
                me->CastSpell(me, ChainGripSearcher, true);
                m_Events.ScheduleEvent(EventChainGrip, urand(8000, 12000));
                break;
            case EventStaggeringBlow:
                if (Unit* target = SelectTarget(SELECT_TARGET_TOPAGGRO))
                    me->CastSpell(target, SpellStaggeringBlow, true);
                m_Events.ScheduleEvent(EventStaggeringBlow, urand(15000, 20000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_night_twisted_devout : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventTaintedClaws, urand(6000, 9000));
        m_Events.ScheduleEvent(EventDevour, urand(8000, 10000));
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventTaintedClaws:
            {
                ...
                m_Events.ScheduleEvent(EventTaintedClaws, urand(8000, 11000));
                break;
            }
            case EventDevour:
            {
                ...
                m_Events.ScheduleEvent(EventDevour, urand(8000, 11000));
                break;
            }
            default:
                break;
...
struct npc_highmaul_gorian_runemaster : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventRuneOfDestruction, urand(6000, 9000));
        m_Events.ScheduleEvent(EventRuneOfDisintegration, urand(9000, 12000));
        m_Events.ScheduleEvent(EventRuneOfUnmaking, urand(4000, 6000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventRuneOfDestruction:
                ...
                m_Events.ScheduleEvent(EventRuneOfDestruction, urand(9000, 12000));
                break;
            case EventRuneOfDisintegration:
                if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                    me->CastSpell(target, SpellRuneOfDisintegration, false);
                m_Events.ScheduleEvent(EventRuneOfDisintegration, urand(12000, 15000));
                break;
            case EventRuneOfUnmaking:
                if (Unit* target = SelectTarget(SELECT_TARGET_TOPAGGRO))
                    me->CastSpell(target, SpellRuneOfUnmaking, false);
                m_Events.ScheduleEvent(EventRuneOfUnmaking, urand(6000, 9000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_gorian_enforcer : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventMeatGrinder, urand(6000, 8000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventMeatGrinder:
                ...
                m_Events.ScheduleEvent(EventMeatGrinder, urand(12000, 15000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_underbelly_vagrant : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventPilfer, urand(2000, 4000));
    }
...
struct npc_highmaul_gorian_sorcerer : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventArcaneForce, urand(6000, 8000));
        m_Events.ScheduleEvent(EventArcaneBolt, urand(7000, 10000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventArcaneForce:
                ...
                m_Events.ScheduleEvent(EventArcaneForce, urand(20000, 25000));
                break;
...
struct npc_highmaul_night_twisted_brute : public ScriptedAI
{
    ...
    void EnterCombat(Unit* attacker) override
    {
        m_Events.ScheduleEvent(EventSurgeOfDarkness, urand(8000, 12000));
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventSurgeOfDarkness:
                ...
                m_Events.ScheduleEvent(EventSurgeOfDarkness, urand(8000, 11000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_night_twisted_soothsayer : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventVoidStorm, urand(6000, 9000));
        m_Events.ScheduleEvent(EventVoidBolt, urand(4000, 7000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventVoidStorm:
                ...
                m_Events.ScheduleEvent(EventVoidStorm, urand(9000, 12000));
                break;
            case EventVoidBolt:
                if (Unit* target = SelectTarget(SELECT_TARGET_TOPAGGRO))
                    me->CastSpell(target, SpellVoidBolt, false);
                m_Events.ScheduleEvent(EventVoidBolt, urand(8000, 11000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_void_aberration : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventVoidSoul, urand(8000, 12000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventVoidSoul:
                ...
                m_Events.ScheduleEvent(EventVoidSoul, urand(8000, 11000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_krush : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventBoarsRush, 5000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventBoarsRush:
                ...
                m_Events.ScheduleEvent(EventBoarsRush, 25000);
                break;
            default:
                break;
        }
...
struct npc_highmaul_iron_flame_technician : public MS::AI::CosmeticAI
{
    ...
    void Reset() override
    {
        ...
        AddDelayedEvent(2 * IN_MILLISECONDS, [this]() -> void
        {
            ...
            {
                m_IsCosmetic = true;
                m_CosmeticEvent.ScheduleEvent(EventFlamethrower, urand(4000, 7000));
            }
        });
    }
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventCorruptedBlood, urand(6000, 9000));
        m_Events.ScheduleEvent(EventFlamethrower, urand(4000, 7000));
        m_Events.ScheduleEvent(EventUnstoppableCharge, urand(9000, 12000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventCorruptedBlood:
                ...
                m_Events.ScheduleEvent(EventCorruptedBlood, urand(13000, 16000));
                break;
            case EventFlamethrower:
                me->CastSpell(me, SpellFlamethrower, false);
                m_Events.ScheduleEvent(EventFlamethrower, urand(14000, 17000));
                break;
            case EventUnstoppableCharge:
                me->CastSpell(me, SpellUnstoppableChargeSearcher, false);
                m_Events.ScheduleEvent(EventUnstoppableCharge, urand(19000, 22000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_iron_warmaster : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventIronBattleRage, urand(6000, 9000));
        m_Events.ScheduleEvent(EventCorruptedBlood, urand(6000, 9000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventIronBattleRage:
                ...
                m_Events.ScheduleEvent(EventIronBattleRage, urand(12000, 15000));
                break;
            case EventCorruptedBlood:
                me->CastSpell(me, SpellCorruptedBlood, false);
                m_Events.ScheduleEvent(EventCorruptedBlood, urand(13000, 16000));
...
struct npc_highmaul_iron_blood_mage : public MS::AI::CosmeticAI
{
    ...
    {
        m_Events.ScheduleEvent(EventCorruptedBlood, urand(6000, 9000));
        m_Events.ScheduleEvent(EventBloodBolt, urand(4000, 7000));
        m_Events.ScheduleEvent(EventCorruptedBloodShield, urand(8000, 11000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            ...
            case EventBloodBolt:
                ...
                m_Events.ScheduleEvent(EventBloodBolt, urand(8000, 11000));
                break;
            case EventCorruptedBloodShield:
                ...
                m_Events.ScheduleEvent(EventCorruptedBloodShield, urand(15000, 18000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_night_twisted_ritualist : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventVoidTouch, urand(3000, 6000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventVoidTouch:
                ...
                m_Events.ScheduleEvent(EventVoidTouch, urand(6000, 9000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_greater_void_aberration : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventCallOfTheVoid, urand(6000, 9000));
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventCallOfTheVoid:
                ...
                m_Events.ScheduleEvent(EventCallOfTheVoid, urand(9000, 12000));
                break;
            default:
                break;
        }
...
struct npc_highmaul_highmaul_conscript : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventRendingSlash, 5 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventShieldBlocking, 13 * IN_MILLISECONDS);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventRendingSlash:
            {
                ...
                m_Events.ScheduleEvent(EventRendingSlash, 20 * IN_MILLISECONDS);
                break;
            }
            case EventShieldBlocking:
            {
                ...
                m_Events.ScheduleEvent(EventShieldCharge, 6 * IN_MILLISECONDS);
                m_Events.ScheduleEvent(EventShieldBlocking, 60 * IN_MILLISECONDS);
                break;
            }
...
struct npc_highmaul_ogron_earthshaker : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventIntimidatingRoar, 6 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventEarthdevastatingSlam, 17 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventIntimidatingRoar:
            {
                ...
                m_Events.ScheduleEvent(EventIntimidatingRoar, 25 * IN_MILLISECONDS);
                break;
            }
            case EventEarthdevastatingSlam:
            {
                ...
                m_Events.ScheduleEvent(EventEarthdevastatingSlam, 60 * IN_MILLISECONDS);
                break;
            }
            default:
                break;
...
struct npc_highmaul_gorian_arcanist : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventArcaneBolt, 6 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventArcaneVolatility, 10 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventArcaneBarrage, 8 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventArcaneBolt:
                ...
                m_Events.ScheduleEvent(EventArcaneBolt, 28 * IN_MILLISECONDS);
                break;
            case EventArcaneVolatility:
                if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                    me->CastSpell(target, ArcaneVolatility, false);
                m_Events.ScheduleEvent(EventArcaneVolatility, 35 * IN_MILLISECONDS);
                break;
            case EventArcaneBarrage:
                me->CastSpell(me, ArcaneBarrage, false);
                m_Events.ScheduleEvent(EventArcaneBarrage, 30 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_ogron_brute : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventDecimate, 6 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventDecimate:
                ...
                m_Events.ScheduleEvent(EventDecimate, 15 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_warden_thultok : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventDestructiveForce, 5 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventArcaneResidue, 10 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventDestructiveForce:
                ...
                m_Events.ScheduleEvent(EventDestructiveForce, 10 * IN_MILLISECONDS);
                break;
...
struct npc_highmaul_gorian_royal_guardsman : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventRampage, 10 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventRampage:
                ...
                m_Events.ScheduleEvent(EventRampage, 20 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_gorian_high_sorcerer : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventArcaneBlast, 5 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventNetherFont, 10 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventCelerity, 15 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventArcaneBlast:
                ...
                m_Events.ScheduleEvent(EventArcaneBlast, 15 * IN_MILLISECONDS);
                break;
            case EventNetherFont:
                me->CastSpell(me, NetherFontSearcher, false);
                m_Events.ScheduleEvent(EventNetherFont, 15 * IN_MILLISECONDS);
                break;
            case EventCelerity:
                if (Unit* target = me->SelectNearbyAlly(me, 50.0f, true))
                    me->CastSpell(target, Celerity, false);
                m_Events.ScheduleEvent(EventCelerity, 20 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_ogron_mauler : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventDeafeningRoar, 5 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventDeafeningRoar:
                ...
                m_Events.ScheduleEvent(EventDeafeningRoar, 15 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_guard_captain_thag : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventBrutalCleave, 5 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventGroundStomp, 7 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventRendingThrow, 10 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventBrutalCleave:
                ...
                m_Events.ScheduleEvent(EventBrutalCleave, 7 * IN_MILLISECONDS);
                break;
            case EventGroundStomp:
                me->CastSpell(me, GroundStomp, true);
                m_Events.ScheduleEvent(EventGroundStomp, 6 * IN_MILLISECONDS);
                break;
            case EventRendingThrow:
                me->CastSpell(me, RendingThrow, true);
                m_Events.ScheduleEvent(EventRendingThrow, 6 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_councilor_daglat : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventArcaneDestruction, 1 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventArcaneDestruction:
                ...
                m_Events.ScheduleEvent(EventArcaneDestruction, 6 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_councilor_magknor : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventArcaneTorrent, 1 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventArcaneTorrent:
                ...
                m_Events.ScheduleEvent(EventArcaneTorrent, 60 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_councilor_gorluk : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventPhantasmalWeapon, 7 * IN_MILLISECONDS);
    }
...
struct npc_highmaul_councilor_nouk : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventTimeStop, 4 * IN_MILLISECONDS);
    }
...
struct npc_highmaul_high_councilor_malgris : public MS::AI::CosmeticAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventUnstableTempest, 50);
    }
