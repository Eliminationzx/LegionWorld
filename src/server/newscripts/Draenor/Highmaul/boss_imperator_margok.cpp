...
struct boss_imperator_margok : public BossAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventMarkOfChaos, 34 * IN_MILLISECONDS, 0, MightOfTheCrown);
        m_Events.ScheduleEvent(EventForceNova, 45 * IN_MILLISECONDS, 0, MightOfTheCrown);
        m_Events.ScheduleEvent(EventArcaneWrath, 6 * IN_MILLISECONDS, 0, MightOfTheCrown);
        m_Events.ScheduleEvent(EventDestructiveResonance, 15 * IN_MILLISECONDS, 0, MightOfTheCrown);
        m_Events.ScheduleEvent(EventArcaneAberration, 25 * IN_MILLISECONDS, 0, MightOfTheCrown);

        if (m_Instance->instance->IsLfr())
            m_Events.ScheduleEvent(EventBerserk, 900 * IN_MILLISECONDS);

        m_CosmeticEvents.ScheduleEvent(EventCheckPlayerZ, 1 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            ...
            case EventMarkOfChaos:
                ...
                Talk(MarkOfChaos);
                m_Events.ScheduleEvent(EventMarkOfChaos, 51 * IN_MILLISECONDS, 0, MightOfTheCrown);
                break;
            case EventForceNova:
            ...
            case EventArcaneWrath:
                ...
                m_Events.ScheduleEvent(EventArcaneWrath, 50 * IN_MILLISECONDS, 0, MightOfTheCrown);
                break;
            ...
            case EventArcaneAberration:
                ...
                m_Events.ScheduleEvent(EventArcaneAberration, 45 * IN_MILLISECONDS, 0, MightOfTheCrown);
                break;
                /// Phase 2
            case EventMarkOfChaosDisplacement:
                ...
                Talk(MarkOfChaos);
                m_Events.ScheduleEvent(EventMarkOfChaosDisplacement, 51 * IN_MILLISECONDS, 0, RuneOfDisplacement);
                break;
            case EventForceNovaDisplacement:
                ...
                m_Events.ScheduleEvent(EventForceNovaDisplacement, 45 * IN_MILLISECONDS, 0, RuneOfDisplacement);
                break;
            case EventArcaneWrathDisplacement:
                Talk(ArcaneWrath);
                me->CastSpell(me, ArcaneWrathDisplacementSearcher, false);
                me->CastSpell(me, ArcaneWrathCosmetic, true);
                m_Events.ScheduleEvent(EventArcaneWrathDisplacement, 50 * IN_MILLISECONDS, 0, RuneOfDisplacement);
                break;
            case EventDestructiveResonanceDisplacement:
                me->CastSpell(me, DestructiveResonanceDisplacementSearch, false);
                me->CastSpell(me, DestructiveResonanceCosmetic, true);
                m_Events.ScheduleEvent(EventDestructiveResonanceDisplacement, 15 * IN_MILLISECONDS, 0, RuneOfDisplacement);
                break;
            case EventArcaneAberrationDisplacement:
                me->CastSpell(me, SummonDisplacingArcaneAberration, false);
                me->CastSpell(me, SummonArcaneAberrationCosmetic, true);
                Talk(ArcaneAberration);
                m_Events.ScheduleEvent(EventArcaneAberrationDisplacement, 45 * IN_MILLISECONDS, 0, RuneOfDisplacement);
                break;
                /// Phase 3
            case EventMarkOfChaosFortification:
                ...
                Talk(MarkOfChaos);
                m_Events.ScheduleEvent(EventMarkOfChaosFortification, 51 * IN_MILLISECONDS, 0, RuneOfFortification);
                break;
            case EventForceNovaFortification:
                ...
                m_Events.ScheduleEvent(EventForceNovaFortification, 45 * IN_MILLISECONDS, 0, RuneOfFortification);
                break;
            case EventArcaneWrathFortification:
                Talk(ArcaneWrath);
                me->CastSpell(me, ArcaneWrathFortificationSearcher, false);
                me->CastSpell(me, ArcaneWrathCosmetic, true);
                m_Events.ScheduleEvent(EventArcaneWrathFortification, 50 * IN_MILLISECONDS, 0, RuneOfFortification);
                break;
            case EventDestructiveResonanceFortification:
                me->CastSpell(me, DestructiveResonanceFortificationSearch, false);
                me->CastSpell(me, DestructiveResonanceCosmetic, true);
                m_Events.ScheduleEvent(EventDestructiveResonanceFortification, 15 * IN_MILLISECONDS, 0, RuneOfFortification);
                break;
            case EventArcaneAberrationFortification:
                me->CastSpell(me, SummonFortifiedArcaneAberration, false);
                me->CastSpell(me, SummonArcaneAberrationCosmetic, true);
                Talk(ArcaneAberration);
                m_Events.ScheduleEvent(EventArcaneAberrationFortification, 45 * IN_MILLISECONDS, 0, RuneOfFortification);
                break;
                /// Phase 4
            case EventMarkOfChaosReplication:
                ...
                Talk(MarkOfChaos);
                m_Events.ScheduleEvent(EventMarkOfChaosReplication, 51 * IN_MILLISECONDS, 0, RuneOfReplication);
                break;
            case EventForceNovaReplication:
                ...
                m_Events.ScheduleEvent(EventForceNovaReplication, 45 * IN_MILLISECONDS, 0, RuneOfReplication);
                break;
            case EventArcaneWrathReplication:
                Talk(ArcaneWrath);
                me->CastSpell(me, ArcaneWrathReplicationSearcher, false);
                me->CastSpell(me, ArcaneWrathCosmetic, true);
                m_Events.ScheduleEvent(EventArcaneWrathReplication, 50 * IN_MILLISECONDS, 0, RuneOfReplication);
                break;
            case EventDestructiveResonanceReplication:
                me->CastSpell(me, DestructiveResonanceReplicationSearch, false);
                me->CastSpell(me, DestructiveResonanceCosmetic, true);
                m_Events.ScheduleEvent(EventDestructiveResonanceReplication, 15 * IN_MILLISECONDS, 0, RuneOfReplication);
                break;
            case EventArcaneAberrationReplication:
                me->CastSpell(me, SummonReplicatingArcaneAberration, false);
                me->CastSpell(me, SummonArcaneAberrationCosmetic, true);
                Talk(ArcaneAberration);
                m_Events.ScheduleEvent(EventArcaneAberrationReplication, 45 * IN_MILLISECONDS, 0, RuneOfReplication);
                break;
            case EventBerserk:
                Talk(Berserk);
    ...
    void ScheduleSecondPhase()
    {
        ...
        AddDelayedEvent(11 * IN_MILLISECONDS, [this]() -> void
        {
            ...
            m_Events.ScheduleEvent(EventMarkOfChaosDisplacement, time, 0, RuneOfDisplacement);

            time = m_Events.GetEventTime(EventForceNova);
            m_Events.ScheduleEvent(EventForceNovaDisplacement, time, 0, RuneOfDisplacement);

            time = m_Events.GetEventTime(EventArcaneWrath);
            m_Events.ScheduleEvent(EventArcaneWrathDisplacement, time, 0, RuneOfDisplacement);

            time = m_Events.GetEventTime(EventDestructiveResonance);
            m_Events.ScheduleEvent(EventDestructiveResonanceDisplacement, time, 0, RuneOfDisplacement);

            time = m_Events.GetEventTime(EventArcaneAberration) + 13 * IN_MILLISECONDS;
            m_Events.ScheduleEvent(EventArcaneAberrationDisplacement, time, 0, RuneOfDisplacement);
        });
    }
    ...
    void ScheduleFirstTransitionPhase()
    {
        ...
        AddDelayedEvent(10 * IN_MILLISECONDS, [this]() -> void
        {
            ...
            m_CosmeticEvents.ScheduleEvent(EventSummonWarmages, 1 * IN_MILLISECONDS);
        });
        ...
        AddDelayedEvent(75 * IN_MILLISECONDS, [this]() -> void
        {
            ...
            m_Events.ScheduleEvent(EventMarkOfChaosFortification, time, 0, RuneOfFortification);

            time = m_Events.GetEventTime(EventForceNovaDisplacement);
            m_Events.ScheduleEvent(EventForceNovaFortification, time, 0, RuneOfFortification);

            time = m_Events.GetEventTime(EventArcaneWrathDisplacement);
            m_Events.ScheduleEvent(EventArcaneWrathFortification, time, 0, RuneOfFortification);

            time = m_Events.GetEventTime(EventDestructiveResonanceDisplacement);
            m_Events.ScheduleEvent(EventDestructiveResonanceFortification, time, 0, RuneOfFortification);

            time = m_Events.GetEventTime(EventArcaneAberrationDisplacement);
            m_Events.ScheduleEvent(EventArcaneAberrationFortification, time, 0, RuneOfFortification);
        });
    }
    ...
    void ScheduleSecondTransitionPhase()
    {
        ...
        AddDelayedEvent(75 * IN_MILLISECONDS, [this]() -> void
        {
            ...
            m_Events.ScheduleEvent(EventMarkOfChaosReplication, time, 0, RuneOfReplication);

            time = m_Events.GetEventTime(EventForceNovaFortification);
            m_Events.ScheduleEvent(EventForceNovaReplication, time, 0, RuneOfReplication);

            time = m_Events.GetEventTime(EventArcaneWrathFortification);
            m_Events.ScheduleEvent(EventArcaneWrathReplication, time, 0, RuneOfReplication);

            time = m_Events.GetEventTime(EventDestructiveResonanceFortification);
            m_Events.ScheduleEvent(EventDestructiveResonanceReplication, time, 0, RuneOfReplication);

            time = m_Events.GetEventTime(EventArcaneAberrationFortification);
            m_Events.ScheduleEvent(EventArcaneAberrationReplication, time, 0, RuneOfReplication);
        });
    }
...
struct npc_highmaul_gorian_warmage : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventFixate, 3 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventSlow, 5 * IN_MILLISECONDS);

        m_CosmeticEvents.ScheduleEvent(EventCheckRune, 1 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventFixate:
                ...
                m_Events.ScheduleEvent(EventNetherBlast, 100);
                m_Events.ScheduleEvent(EventFixate, 15 * IN_MILLISECONDS);
                break;
            case EventSlow:
                me->CastSpell(me, Slow, true);
                m_Events.ScheduleEvent(EventSlow, 17 * IN_MILLISECONDS);
                break;
            case EventNetherBlast:
                if (Unit* target = Player::GetPlayer(*me, m_FixateTarget))
                    me->CastSpell(target, NetherBlast, false);

                m_Events.ScheduleEvent(EventNetherBlast, 200);
                break;
            default:
                break;
        }
...
struct npc_highmaul_gorian_reaver : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventCrushArmor, 22 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventKickToTheFace, 41 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventDevastatingShockwave, 12 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventCrushArmor:
                ...
                m_Events.ScheduleEvent(EventCrushArmor, 11 * IN_MILLISECONDS);
                break;
            case EventKickToTheFace:
                ...
                m_Events.ScheduleEvent(EventKickToTheFace, 25 * IN_MILLISECONDS);
                break;
