...
struct boss_kargath_bladefist : public BossAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventImpale, 35000);
        m_Events.ScheduleEvent(EventBladeDance, 3000);

        if (!m_Instance->instance->IsLfr())
            m_Events.ScheduleEvent(EventOpenGrates, 4000);

        m_Events.ScheduleEvent(EventBerserkerRush, 48000);
        m_Events.ScheduleEvent(EventChainHurl, 91000);
        m_Events.ScheduleEvent(EventBerserker, 600000);
        m_Events.ScheduleEvent(EventSpawnIronBombers, 60000);

        if (IsMythicRaid())
            m_Events.ScheduleEvent(EventFreeTiger, 110000);
    ...
    void MovementInform(uint32 type, uint32 id) override
    {
        ...
        switch (id)
        {
            case MoveFrontGate:
                ...
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC);
                me->SetWalk(false);
                m_CosmeticEvents.ScheduleEvent(OrientationForFight, 500);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventImpale:
                ...
                m_Events.ScheduleEvent(EventImpale, 43500);
                break;
            case EventBladeDance:
                me->CastSpell(me, SpellBladeDance, true);
                m_Events.ScheduleEvent(EventBladeDance, 20000);
                break;
            ...
            case EventBerserkerRush:
                ...
                Talk(BerserkerRush);
                m_Events.ScheduleEvent(EventBerserkerRush, 45000);
                break;
            case EventChainHurl:
            {
                ...
                m_Events.ScheduleEvent(EventChainHurl, 106000);
                m_CosmeticEvents.ScheduleEvent(EventEndOfArenasStands, 45000);
                ...
                m_CosmeticEvents.ScheduleEvent(EventEndOfChainHurl, 14000);
                break;
            }
            case EventBerserker:
...
struct npc_highmaul_vulgor : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_Events.ScheduleEvent(EventCleave, 5000);
        m_Events.ScheduleEvent(EventEarthBreaker, 8000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventCleave:
                ...
                m_Events.ScheduleEvent(EventCleave, 19000);
                break;
            case EventEarthBreaker:
                me->CastSpell(me, EarthBreakerSearch, true);
                m_Events.ScheduleEvent(EventEarthBreaker, 15000);
                break;
            default:
                break;
        }
...
struct npc_highmaul_bladespire_sorcerer : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventMoltenBomb, 5000);
        m_Events.ScheduleEvent(EventFlameBolt, 2000);
        m_Events.ScheduleEvent(EventSearingArmor, 8000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventMoltenBomb:
                ...
                m_Events.ScheduleEvent(EventMoltenBomb, 15000);
                break;
            case EventFlameBolt:
                me->CastSpell(me, SpellFlameBoltSearcher, true);
                m_Events.ScheduleEvent(EventFlameBolt, 10000);
                break;
...
struct npc_highmaul_somldering_stoneguard : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventCleave, 2000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventCleave:
                ...
                m_Events.ScheduleEvent(EventCleave, 10000);
                break;
            default:
                break;
        }
...
struct npc_highmaul_ravenous_bloodmaw : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        m_Events.Reset();
        m_Events.ScheduleEvent(CheckPlayer, 500);
...
struct npc_highmaul_drunken_bileslinger : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        m_ClassicEvent.ScheduleEvent(EventMaulingBrew, urand(3000, 5000));
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/, DamageEffectType dmgType) override
    {
        if (me->HasReactState(REACT_PASSIVE))
        {
            m_ClassicEvent.Reset();
            me->SetReactState(REACT_AGGRESSIVE);
            m_FightEvent.ScheduleEvent(EventVileBreath, 3000);
            m_ClassicEvent.ScheduleEvent(EventHeckle, 6000);
        }
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_ClassicEvent.ExecuteEvent())
        {
            case EventMaulingBrew:
                ...
                m_ClassicEvent.ScheduleEvent(EventMaulingBrew, urand(15000, 25000));
                break;
            case EventHeckle:
                me->CastSpell(me, Heckle, false);
                m_ClassicEvent.ScheduleEvent(EventHeckle, 10000);
                break;
            default:
                break;
        }
        ...
        if (m_FightEvent.ExecuteEvent() == EventVileBreath)
        {
            ...
            m_FightEvent.ScheduleEvent(EventVileBreath, 10000);
        }
...
struct npc_highmaul_iron_bomber : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        m_Events.Reset();
        m_Events.ScheduleEvent(EventIronBomb, urand(3000, 6000));
    }
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType dmgType) override
    {
        if (me->HasReactState(REACT_PASSIVE))
        {
            ...
            m_Events.ScheduleEvent(EventHeckle, 6000);
        }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventIronBomb:
                ...
                m_Events.ScheduleEvent(EventIronBomb, urand(5000, 9000));
                break;
            case EventHeckle:
                me->CastSpell(me, Heckle, false);
                m_Events.ScheduleEvent(EventHeckle, 6000);
...
struct npc_highmaul_iron_grunt_second : public MS::AI::CosmeticAI
{
    ...
    void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/, DamageEffectType dmgType) override
    {
        if (me->HasReactState(REACT_PASSIVE))
        {
            me->SetReactState(REACT_AGGRESSIVE);
            m_Events.Reset();
            m_Events.ScheduleEvent(EventGrapple, 3000);
        }
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (m_Events.ExecuteEvent() == EventGrapple)
        {
            ...
            m_Events.ScheduleEvent(EventGrapple, 6000);
        }
...
struct npc_highmaul_areatrigger_for_crowd : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        m_Events.Reset();
        m_Events.ScheduleEvent(InitObscured, 2000);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (m_Events.ExecuteEvent() == InitObscured)
        {
            ...
            m_Events.ScheduleEvent(InitObscured, 3000);
        }
    }
