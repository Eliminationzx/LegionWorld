...
struct boss_koragh : public BossAI
{
    ...
    void DoAction(int32 const action) override
    {
        switch (action)
        {
            case CancelBreakersStrength:
                ...
                m_CosmeticEvents.ScheduleEvent(EventEndOfCharging, 15 * IN_MILLISECONDS);
                break;
    ...
    void MovementInform(uint32 type, uint32 id) override
    {
        switch (id)
        {
            case MoveToCenter:
            {
                ...
                m_CosmeticEvents.ScheduleEvent(EventEndOfCharging, 20 * IN_MILLISECONDS);
                break;
            }
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        ...
        m_CosmeticEvents.ScheduleEvent(EventBreakersStrength, 10 * IN_MILLISECONDS);

        m_Events.ScheduleEvent(EventExpelMagicFire, 6 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventExpelMagicArcane, 30 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventExpelMagicFrost, 40 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventExpelMagicShadow, 55 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventSuppressionField, 15 * IN_MILLISECONDS);
        m_Events.ScheduleEvent(EventOverflowingEnergy, 36 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventExpelMagicFire:
                ...
                Talk(ExpelMagic);
                m_Events.ScheduleEvent(EventExpelMagicFire, 60 * IN_MILLISECONDS);
                break;
            ...
            case EventExpelMagicFrost:
                ...
                Talk(ExpelMagic);
                m_Events.ScheduleEvent(EventExpelMagicFrost, 60 * IN_MILLISECONDS);
                break;
            case EventExpelMagicShadow:
                me->CastSpell(me, ExpelMagicShadow, false);
                Talk(ExpelMagic);
                m_Events.ScheduleEvent(EventExpelMagicShadow, 60 * IN_MILLISECONDS);
                break;
            case EventSuppressionField:
            {
                ...
                m_Events.ScheduleEvent(EventSuppressionField, 17 * IN_MILLISECONDS);
                break;
            }
            case EventOverflowingEnergy:
            {
                me->CastSpell(me, OverflowingEnergySpawn, true);
                m_Events.ScheduleEvent(EventOverflowingEnergy, 30 * IN_MILLISECONDS);
                break;
            }
            default:
                break;
...
struct npc_highmaul_breaker_of_fel : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventFelNova, 12 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventFelNova:
                ...
                m_Events.ScheduleEvent(EventFelNova, 25 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_breaker_of_fire : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventWildFlames, 4 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventWildFlames:
                ...
                m_Events.ScheduleEvent(EventWildFlames, 11 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
...
struct npc_highmaul_breaker_of_frost : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        m_Events.ScheduleEvent(EventFrozenCore, 4 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (m_Events.ExecuteEvent())
        {
            case EventFrozenCore:
                ...
                m_Events.ScheduleEvent(EventFrozenCore, 13 * IN_MILLISECONDS);
                break;
            default:
                break;
        }
