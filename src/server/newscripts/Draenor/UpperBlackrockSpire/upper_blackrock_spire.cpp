    ...
    struct npc_leeroy_jenkinsAI : public ScriptedAI
    {
        ...
        void SpellHit(Unit* caster, SpellInfo const* spellInfo)
        {
            if (IsHeroic() && instance->GetBossState(DATA_KYRAK) == DONE)
            {
                ...
                events.ScheduleEvent(TALK_0, 1000);
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case TALK_0:
                Talk(TALK_INTRO_1);
                events.ScheduleEvent(TALK_1, 8000);
                break;
            case TALK_1:
                me->SetUInt32Value(UNIT_FIELD_STATE_ANIM_ID, 0);
                Talk(TALK_INTRO_2);
                me->GetMotionMaster()->MovePoint(0, 74.720f, -319.148f, 91.446f);
                events.ScheduleEvent(TALK_2, 13000);
                break;
            case TALK_2:
                Talk(TALK_INTRO_3);
                events.ScheduleEvent(TALK_3, 9000);
                break;
            case TALK_3:
                Talk(TALK_INTRO_4);
                events.ScheduleEvent(TALK_4, 10000);
                break;
            case TALK_4:
            {
                Talk(TALK_INTRO_5);
                events.ScheduleEvent(EVENT_MOVE, 6500);
                break;
            }
            case EVENT_UPDATE_CHICKEN:
            {
                ...
                {
                    --ChickenTimer;
                    events.ScheduleEvent(EVENT_UPDATE_CHICKEN, 1000);
                }
            ...
            case EVENT_SHOULDERS:
                ...
                Talk(TALK_SHOULDERS);
                events.ScheduleEvent(EVENT_SHOULDERS_APPLY, 3000);
                break;
            case EVENT_SHOULDERS_APPLY:
                ...
                events.ScheduleEvent(EVENT_FINAL, 3000);
                break;
            case EVENT_FINAL:
                Talk(TALK_GARRISON);
                me->SetUInt32Value(UNIT_FIELD_STATE_ANIM_ID, 0);
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            case 2:
                ...
                ChickenTimer = 900;
                events.ScheduleEvent(EVENT_UPDATE_CHICKEN, 1000);
                events.ScheduleEvent(EVENT_CHICKEN, 1000000);
                events.ScheduleEvent(EVENT_MOVE_3, 334000);
            ...
            case 4:
                me->SetUInt32Value(UNIT_FIELD_STATE_ANIM_ID, ANIM_KNEEL_LOOP);
                events.ScheduleEvent(EVENT_SHOULDERS, 2000);
                break;
            default:
                break;
            }
...
public:
    ...
    struct npc_son_of_the_beastAI : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_FIERY_CHARGE, 8000);
            events.ScheduleEvent(EVENT_FLAME_ERUPTION, 15000);
            events.ScheduleEvent(EVENT_TERRIFYING_ROAL, 20000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_FIERY_CHARGE:
                ...
                events.ScheduleEvent(EVENT_FIERY_CHARGE, 8000);
                events.ScheduleEvent(EVENT_CHARGE_STOP, 600);
                charging = true;
                break;
