            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_SUMMON_4:
                        ...
                        // временный фикс, нужно ласт фазу с драконом исправить. (но для Лироя нид пройти этого босса) {
                        me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_NON_ATTACKABLE);
                        me->GetMotionMaster()->MoveJump(151.72f, -421.22f, 110.4722f, 4.739905f, 2.0f, 2);
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            switch (id)
            {
                ...
                case 6:
                    ...
                    if (Creature* tharbek = ObjectAccessor::GetCreature(*me, tharbekGUID))
                    {
                        tharbek->SetReactState(REACT_AGGRESSIVE);
                        tharbek->AI()->DoAction(2);
                    }
