...
void TargetedMovementGeneratorMedium<T,D>::_setTargetLocation(T &owner)
{
    ...
    if(static_cast<D*>(this)->GetMovementGeneratorType() == FOLLOW_MOTION_TYPE)
    {
        ...
        // sLog->outDebug(LOG_FILTER_PETS, "_setTargetLocation FOLLOW_MOTION_TYPE %u IsWithinLOSInMap (%f %f %f) GetAttackDist %f", owner.GetEntry(), x, y , z, ((Creature*)&owner)->GetAttackDist());
    }
    else
    {
        ...
        // sLog->outDebug(LOG_FILTER_PETS, "_setTargetLocation %u IsWithinLOSInMap (%f %f %f) GetAttackDist %f", owner.GetEntry(), x, y , z, ((Creature*)&owner)->GetAttackDist());
    }
