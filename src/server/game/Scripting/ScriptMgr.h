...
/*
    ...
    class MyScriptType : public ScriptObject
    {
        ...
        protected:
            ...
            MyScriptType(std::string name, uint32 someId)
...
public:
    ...
    virtual bool OnTrigger(Player* /*player*/, EventObject* /*trigger*/) { return false; }
};
...
class ScriptMgr
{
    ...
    public: /* Initialization */
        ...
        bool OnEventObject(Player* player, EventObject* event);
