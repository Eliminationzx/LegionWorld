...
void AuraApplication::_HandleEffect(uint8 effIndex, bool apply)
{
    ...
    #ifdef WIN32
    sLog->outDebug(LOG_FILTER_SPELLS_AURAS, "AuraApplication::_HandleEffect: GetId %i, GetAuraType %u, apply: %u: amount: %i, m_send_baseAmount: %i, effIndex: %i GetDuration %i, guid %u GetStackAmount %u GetComboPoints %u GetCharges %u",
...
void AuraApplication::BuildUpdatePacket(WorldPackets::Spells::AuraInfo& auraInfo, bool remove, uint32 overrideAura /*= 0*/)
{
    ...
    if (sandboxScalingData.GenerateDataFromUnits(ObjectAccessor::GetUnit(*GetTarget(), aura->GetCasterGUID()), GetTarget()))
        ...
        if (AuraEffect const* effect = aura->GetEffect(i))
        {
            switch (effect->GetAuraType())
            {
                ...
                case SPELL_AURA_MOD_DISARM_RANGED:
                {
                    ...
                    loosOfControlInfo.Type = LOC_DISARM;
                ...
                case SPELL_AURA_MOD_SILENCE:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_SILENCE;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_PACIFY:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_PACIFY;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_PACIFY_SILENCE:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_PACIFYSILENCE;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_CONFUSE:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_CONFUSE;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_FEAR_2:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_FEAR;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_STUN:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_STUN_MECHANIC;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_ROOTED:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_ROOT;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_POSSESS:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_POSSESS;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
                ...
                case SPELL_AURA_MOD_CHARM:
                {
                    WorldPackets::Spells::LossOfControlInfo loosOfControlInfo;
                    loosOfControlInfo.Mechanic = aura->GetSpellInfo()->GetEffectMechanic(i);
                    loosOfControlInfo.Type = LOC_CHARM;
                    loosOfControlInfo.AuraSlot = GetSlot();
                    loosOfControlInfo.EffectIndex = i;
                    loosOfControl.Infos.push_back(loosOfControlInfo);
                    break;
...
Aura* Aura::Create(SpellInfo const* spellproto, uint32 effMask, WorldObject* owner, Unit* caster, float* baseAmount, Item* castItem, ObjectGuid casterGUID, uint16 stackAmount, Spell* spell)
{
    ...
    if (owner->IsUnit())
        if (!owner->IsInWorld() || static_cast<Unit*>(owner)->IsDuringRemoveFromWorld())
            // owner not in world so don't allow to own not self casted single target auras
            if (casterGUID != owner->GetGUID() && (spellproto->IsSingleTarget(caster, static_cast<Unit*>(owner)) || spellproto->IsMultiSingleTarget()))
                return nullptr;

    Aura* aura = nullptr;
    if(spellproto->IsSingleTarget(caster, static_cast<Unit*>(owner)))
    {
        if (caster)
        {
...
m_damage_amount(0), m_spellInfo(spellproto), m_casterGuid(!casterGUID.IsEmpty() ? casterGUID : caster->GetGUID()), m_castItemGuid(castItem ? castItem->GetGUID() : ObjectGuid::Empty), m_applyTime(time(nullptr)),
m_applyMSTime(getMSTime()), m_owner(owner), m_SpellVisual(0), m_timeCla(0), m_updateTargetMapInterval(0), m_casterLevel(caster ? caster->getLevelForTarget(owner) : m_spellInfo->SpellLevel), m_procCharges(0),
m_stackAmount(stackAmount ? stackAmount: 1), m_diffMode(caster ? caster->GetSpawnMode() : 0), m_customData(0), m_isRemoved(0), TimeMod(1.0f)
{
...
{
    ApplicationMap::guarded_ptr ptr = m_applications.get(guid);
    if (ptr)
...
void Aura::UpdateTargetMap(Unit* caster, bool apply)
{
    ...
    for (ApplicationMap::iterator appIter = m_applications.begin(); appIter != m_applications.end(); ++appIter)
    {
        ...
        std::map<Unit*, uint32>::iterator existing = targets.find(aurApp->GetTarget());
...
void Aura::HandleAuraSpecificMods(AuraApplication const* aurApp, Unit* caster, bool apply, bool onReapply)
{
    ...
    // sLog->outDebug(LOG_FILTER_SPELLS_AURAS, "HandleAuraSpecificMods GetId %u removeMode %u caster %u", GetId(), removeMode, bool(caster));
                ...
                case 19574: // Bestial Wrath
                    if (target->HasAura(197248)) // Master of Beasts
                        if (Unit* hati = target->GetHati())
                            target->CastSpell(hati, 207033, false);
                    break;
                default:
                    break;
            }
    ...
    if (IsPassive() && target->IsPlayer())
    {
        if (GetSpellInfo()->EquippedItemClass == ITEM_CLASS_WEAPON)
        {
            ...
            if (eventInfo.GetDamageInfo())
            {
                ...
                if (!item || item->CantBeUse() || item->GetTemplate()->Class != ITEM_CLASS_WEAPON)
                    return false;

                if (GetSpellInfo()->EquippedItemSubClassMask && !((1<<item->GetTemplate()->SubClass) & GetSpellInfo()->EquippedItemSubClassMask))
                    return false;
            }
        }
        else if (GetSpellInfo()->EquippedItemClass == ITEM_CLASS_ARMOR)
        {
            ...
            if (!item || item->CantBeUse() || item->GetTemplate()->Class != ITEM_CLASS_ARMOR)
                return false;
...
void Aura::CallScriptEffectUpdateHandlers(uint32 diff, AuraEffect* aurEff)
{
    ...
    for (std::list<AuraScript*>::iterator scritr = m_loadedScripts.begin(), next; scritr != m_loadedScripts.end(); scritr = next)
    {
        next = scritr;
        ++next;
...
void Aura::CallScriptEffectSplitDamageHandlers(AuraEffect* aurEff, AuraApplication const* aurApp, DamageInfo & dmgInfo, float & absorbAmount)
{
    ...
    for (std::list<AuraScript*>::iterator scritr = m_loadedScripts.begin(); scritr != m_loadedScripts.end(); ++scritr)
    {
        ...
        std::list<AuraScript::EffectAbsorbHandler>::iterator effEndItr = (*scritr)->OnEffectSplitDamage.end(), effItr = (*scritr)->OnEffectSplitDamage.begin();
        for (; effItr != effEndItr; ++effItr)
        {
            if ((*effItr).IsEffectAffected(m_spellInfo, aurEff->GetEffIndex()))
                (*effItr).Call(*scritr, aurEff, dmgInfo, absorbAmount);
                ...
                switch (GetSpellInfo()->GetEffect(effIndex, m_diffMode)->Effect)
                {
                    ...
                    case SPELL_EFFECT_APPLY_AURA_WITH_VALUE:
                    {
                        if (!(m_spellInfo->HasAttribute(SPELL_ATTR1_CANT_TARGET_SELF)))
                            targetList.push_back(GetUnitOwner());
                        for (Unit::ControlList::iterator itr = GetUnitOwner()->m_Controlled.begin(); itr != GetUnitOwner()->m_Controlled.end(); ++itr)
                        {
                            if (Unit* unit = *itr)
                                if (unit->IsInWorld())
