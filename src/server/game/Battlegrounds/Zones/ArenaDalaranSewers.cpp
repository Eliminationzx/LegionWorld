...
ArenaDalaranSewers::ArenaDalaranSewers() : _waterfallTimer(0), _waterfallKnockbackTimer(0), _pipeKnockBackTimer(0), _pipeKnockBackCount(0), _waterfallStatus(0), _getOutFromTexturesTimer(0)
{
