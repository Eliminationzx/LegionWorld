...
public:
    ...
    bool IsSkirmish() const { return m_IsArena && !m_IsRated && !m_IsRBG/*_isSkirmish*/; }
    ...
    void PlayerReward(Player* player, bool isWinner, uint16 personalRating);
