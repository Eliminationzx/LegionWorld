    ...
    namespace Battlegrounds
    {
        ...
        namespace BattlegroundTypeId
        {
            enum : uint16
            {
                ...
                BrawlBattleground10 = 853,
                BrawlBattleground8 = 857,
                BrawlBattlegroundKotmoguTemplate = 858,
                BrawlBattleground4 = 859,                   // Eye of the Storm
        ...
        static bool CheckIsBrawlByTypeID(uint16 bgTypeID)
        {
            switch (bgTypeID)
            {
                ...
                case BattlegroundTypeId::BrawlBattleground10:
                case BattlegroundTypeId::BrawlBattleground8:
                case BattlegroundTypeId::BrawlBattlegroundKotmoguTemplate:
                case BattlegroundTypeId::BrawlBattleground4:
        ...
        static uint8 GetBgQueueTypeIdByBgTypeID(uint16 bgTypeID, uint8 joinType = 0)
        {
            switch (bgTypeID)
            {
                ...
                case BattlegroundTypeId::BrawlBattleground8:
                case BattlegroundTypeId::BrawlBattlegroundKotmoguTemplate:
                case BattlegroundTypeId::BrawlBattleground4:                   // Eye of the Storm
