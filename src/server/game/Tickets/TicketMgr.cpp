...
GmTicket::GmTicket(Player* player, WorldPackets::Ticket::SupportTicketSubmitBug& packet) : _createTime(time(nullptr)), _lastModifiedTime(time(nullptr)), _assignedTo(), _completed(false), _escalatedStatus(TICKET_UNASSIGNED), _viewed(false)
{
