...
Entity::Entity(VignetteEntry const* vignetteEntry, uint32 const mapID) : _zoneID{ 0 }
{
...
void Entity::Create(Type type, Position position, uint32 zoneID, ObjectGuid sourceGuid)
{
