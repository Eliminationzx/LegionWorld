...
struct LootStoreItem
{
    ...
    bool Roll(bool rate, bool isDungeon = false) const;                             // Checks if the entry takes it's chance (at loot generation)
...
class LootTemplate
{
    ...
    public:
        ...
        void ProcessWorld(Loot& loot, bool ignore = false) const;
...
typedef std::unordered_map<ObjectGuid, Loot> PersonalLootMap;
