...
{
    LfgShortageData() : totalTanks(0), totalHealers(0), totalDps(0), shortageRoles(0), queueId(0), shortageRolesCalculated(false) { }
    LfgShortageData(uint32 tanks, uint32 healers, uint32 dps, uint32 _queueId) : totalTanks(tanks), totalHealers(healers), totalDps(dps), shortageRoles(0), queueId(_queueId), shortageRolesCalculated(false) { }
