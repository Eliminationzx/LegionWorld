    ...
    namespace Spells
    {
        ...
        class SandboxScalingData
        {
            enum Types : uint32
            {
                DONT_SCALE                      = 0,
                PLAYER_TO_PLAYER                = 1,
                CREATURE_TO_PLAYER_DAMAGE       = 2,
                PLAYER_TO_CREATURE_DAMAGE       = 3,
                CREATURE_TO_CREATURE_DAMAGE     = 4,
            };
        ...
        public:
            ...
            void GenerateDataForPlayerToPlayer(Player* attacker, Player* target);

            uint32 Type = DONT_SCALE;
