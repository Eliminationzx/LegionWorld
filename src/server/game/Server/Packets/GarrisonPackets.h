...
namespace WorldPackets
{
    namespace Garrison
    {
        ...
        {
            GarrisonBuildingLandmark() = default;
            GarrisonBuildingLandmark(uint32 buildingPlotInstId, Position const& pos) : Pos(pos), GarrBuildingPlotInstID(buildingPlotInstId) { }
