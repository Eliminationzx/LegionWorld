...
struct AreaTriggerCircle
{
    ...
    Optional<TaggedPosition<Position::XYZ>> CenterPoint;
...
class AreaTrigger : public WorldObject, public GridObject<AreaTrigger>, public MapObject
{
    ...
    public:
        ...
        bool CreateAreaTrigger(ObjectGuid::LowType guidlow, uint32 triggerEntry, Unit* caster, SpellInfo const* info, Position const& pos, Position const& posMove, Spell* spell = nullptr, ObjectGuid targetGuid = ObjectGuid::Empty, uint32 customEntry = 0, ObjectGuid castID = ObjectGuid::Empty);
        ...
        void ReCalculateSplinePosition();
        ...
        void SetSphereScale(float mod, uint32 time, bool absolute_change = false, float scaleMin = 0.1f, float scaleMax = 100.0f);
