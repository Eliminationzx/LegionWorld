...
enum TriggerCastFlags
{
    ...
    TRIGGERED_FULL_MASK                             = 0xFFE7FFFF,   //! all flags except TRIGGERED_CASTED_BY_AREATRIGGER | TRIGGERED_IGNORE_LOS
};
...
public:
    ...
    void SetIsCrit(bool crit) { m_isCrit = crit; }
...
enum PlayerTotemType
{
    ...
    SUMMON_TYPE_TOTEM_FIRE2 = 3211,
    SUMMON_TYPE_TOTEM_FIRE3 = 3697,

    SUMMON_TYPE_TOTEM_EARTH =  81,
    SUMMON_TYPE_TOTEM_EARTH2 = 3787,
    SUMMON_TYPE_TOTEM_EARTH3 = 3737,
    SUMMON_TYPE_TOTEM_EARTH4 = 3722,
    SUMMON_TYPE_TOTEM_EARTH5 = 3404,
    SUMMON_TYPE_TOTEM_EARTH6 = 3804,
    SUMMON_TYPE_TOTEM_EARTH7 = 3400,

    SUMMON_TYPE_TOTEM_WATER =  82,
    SUMMON_TYPE_TOTEM_WATER2 = 3402,
    SUMMON_TYPE_TOTEM_WATER3 = 3399,

    SUMMON_TYPE_TOTEM_AIR =  83,
    SUMMON_TYPE_TOTEM_AIR2 = 3695,
    SUMMON_TYPE_TOTEM_AIR3 = 3406,
    SUMMON_TYPE_TOTEM_AIR4 = 3806,
    SUMMON_TYPE_TOTEM_AIR5 = 3407,
    SUMMON_TYPE_TOTEM_AIR6 = 3755
};
...
class Unit : public WorldObject
{
    ...
    public:
        ...
        void SendCombatLogMessage(WorldPackets::CombatLog::CombatLogServerPacket* combatLog);
        ...
        void ProcDamageAndSpell(Unit* victim, uint32 procAttacker, uint32 procVictim, uint32 procEx, DamageInfo* dmgInfoProc, WeaponAttackType attType = BASE_ATTACK, SpellInfo const* procSpell = nullptr, SpellInfo const* procAura = nullptr, Uint32Set* AppliedProcMods = nullptr);
        void ProcDamageAndSpellFor(bool isVictim, Unit* target, uint32 procFlag, uint32 procExtra, WeaponAttackType attType, SpellInfo const* procSpell, DamageInfo* dmgInfoProc, SpellInfo const* procAura = nullptr, Uint32Set* AppliedProcMods = nullptr);
        ...
        void CastSpellDuration(Unit* victim, uint32 spellId, bool triggered, uint32 duration = 0, uint32 stack = 0, uint32 timeCast = 0);
        ...
        */
        ...
        int32 m_addPower[MAX_POWERS];
        int32 m_powerRegenTimer[MAX_POWERS + 1]; // max = health
        int32 m_powerCombatTimer[MAX_POWERS + 1]; // max = health
        ...
        void ResetCustomDisplayId() { if (GetDisplayId() == _customDisplayId) DeMorph(); _customDisplayId = 0; }
        ...
        void CreateAreaTrigger(uint32 id, float x = 0, float y = 0, float z = 0, float orientation = 0);
...
{
    public:
        DelaySummonEvent(Creature& _summoner, uint32 _summon, Position _pos, float _modZ = 0.0f) : m_owner(_summoner), summon(_summon), pos(_pos), modZ(_modZ) {}
        bool Execute(uint64, uint32) override;
