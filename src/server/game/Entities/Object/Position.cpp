...
bool Position::IsPointInBox(Position centerBox, std::vector<Position> box, Position point) const
{
...
Position Position::operator-(const Position& rkVector) const
{
...
WorldLocation::WorldLocation(uint32 _mapid, Position pos): m_mapId(_mapid)
{
    Relocate(pos);
}
