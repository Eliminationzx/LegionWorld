...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        bool HasPhaseId() const { return !m_phaseId.empty(); }
        ...
        bool IsWithinDist(WorldObject const* obj, float dist2compare, bool is3D = true) const; // use only if you will sure about placing both object at same map
