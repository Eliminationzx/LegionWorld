...
WardenTimer::WardenTimer(uint32 time, uint32 reqLevel, bool reqPlayerInWorld) : _initTime(time), _enabled(false), _reqLevel(reqLevel), _reqPlayer(reqPlayerInWorld) 
{
