...
enum SMART_EVENT
{
    ...
    SMART_EVENT_EVENTOBJECT_ONTRIGGER    = 75,      // EventObject(0 any)
...
enum SmartEventFlags
{
    ...
    SMART_EVENT_FLAG_ALLOW_EVENT_NON_COMBAT = 0x020,
    ...
    SMART_EVENT_FLAGS_ALL                   = (SMART_EVENT_FLAG_NOT_REPEATABLE|SMART_EVENT_FLAG_DIFFICULTY_ALL|SMART_EVENT_FLAG_ALLOW_EVENT_NON_COMBAT|SMART_EVENT_FLAG_RESERVED_6|SMART_EVENT_FLAG_DEBUG_ONLY|SMART_EVENT_FLAG_DONT_RESET)
};
