...
void WorldSession::HandleArtifactAddRelicTalent(WorldPackets::Artifact::ArtifactAddRelicTalent& packet)
{
    ...
    //GameObjectGUID: HighType: GameObject; SubType: 0; Low: 8258587; RealmdID: 1467; ServerID: 26822; Map: 1669; Entry: 273273 (Тигель света Пустоты); Full: 0x2C16ECD0A10ADE400068C600007E041B
    //TalentIndex: 2
    //SlotIndex: 0
