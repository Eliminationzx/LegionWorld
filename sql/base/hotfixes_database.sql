...
CREATE TABLE `hotfix_data` (
  ...
  PRIMARY KEY (`Id`, `TableHash`,`RecordID`,`Timestamp`)
...
CREATE TABLE `battle_pet_effect_properties_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT '0',
  `locale` varchar(4) NOT NULL,
  `ParamLabel1_lang` text,
  `ParamLabel2_lang` text,
  `ParamLabel3_lang` text,
  `ParamLabel4_lang` text,
  `ParamLabel5_lang` text,
  `ParamLabel6_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `character_service_info_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `FlowTitle_lang` text,
  `PopupTitle_lang` text,
  `PopupDescription_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `chr_races_locale` (
  ...
  `NameFemale_lowercase_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `item_sparse` (
  ...
  `AllowableClass` smallint(5) unsigned NOT NULL DEFAULT '0',
  `ItemLevel` smallint(5) unsigned NOT NULL DEFAULT '0',
  `RequiredSkill` smallint(5) unsigned NOT NULL DEFAULT '0',
  `RequiredSkillRank` smallint(5) unsigned NOT NULL DEFAULT '0',
  `MinFactionID` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `lock_type_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Name_lang` text,
  `ResourceName_lang` text,
  `Verb_lang` text,
  `CursorName_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `power_type_locale` (
  `ID` int(10) unsigned NOT NULL DEFAULT '0',
  `locale` varchar(4) NOT NULL,
  `NameGlobalStringTag_lang` text,
  `CostGlobalStringTag_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `world_state_u_i_locale` (
  ...
  `locale` varchar(4) NOT NULL,
  `Icon_lang` text,
  `ExtendedUI_lang` text,
  `DynamicTooltip_lang` text,
  `String_lang` text,
  `Tooltip_lang` text,
  `VerifiedBuild` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`locale`)
